...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Int_alignment) == 24, "");
_Static_assert(_Alignof(struct Int_alignment) == 8, "");
_Static_assert(sizeof(struct Int_packed) == 12, "");
_Static_assert(_Alignof(struct Int_packed) == 1, "");
_Static_assert(sizeof(struct Int_required_alignment) == 13, "");
_Static_assert(_Alignof(struct Int_required_alignment) == 1, "");
_Static_assert(sizeof(struct Int_size) == 14, "");
_Static_assert(_Alignof(struct Int_size) == 1, "");
#endif
_Static_assert(sizeof(Y) == 40, "");
_Static_assert(_Alignof(Y) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 48, "");
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 40, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 41, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 42, "");
_Static_assert(_Alignof(struct Y_size) == 1, "");
#endif
_Static_assert(sizeof(Z) == 48, "");
_Static_assert(_Alignof(Z) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Z_alignment) == 56, "");
_Static_assert(_Alignof(struct Z_alignment) == 8, "");
_Static_assert(sizeof(struct Z_packed) == 48, "");
_Static_assert(_Alignof(struct Z_packed) == 1, "");
_Static_assert(sizeof(struct Z_required_alignment) == 49, "");
_Static_assert(_Alignof(struct Z_required_alignment) == 1, "");
_Static_assert(sizeof(struct Z_size) == 50, "");
_Static_assert(_Alignof(struct Z_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(sizeof(struct Y_alignment) == 48, "");
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 36, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 37, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 38, "");
_Static_assert(_Alignof(struct Y_size) == 1, "");
#endif
_Static_assert(sizeof(Z) == 40, "");
_Static_assert(_Alignof(Z) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Z_alignment) == 48, "");
_Static_assert(_Alignof(struct Z_alignment) == 8, "");
_Static_assert(sizeof(struct Z_packed) == 40, "");
_Static_assert(_Alignof(struct Z_packed) == 1, "");
_Static_assert(sizeof(struct Z_required_alignment) == 41, "");
_Static_assert(_Alignof(struct Z_required_alignment) == 1, "");
_Static_assert(sizeof(struct Z_size) == 42, "");
_Static_assert(_Alignof(struct Z_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(struct Int_alignment) == 8, "");
_Static_assert(sizeof(struct Int_packed) == 6, "");
_Static_assert(_Alignof(struct Int_packed) == 1, "");
_Static_assert(sizeof(struct Int_required_alignment) == 7, "");
_Static_assert(_Alignof(struct Int_required_alignment) == 1, "");
_Static_assert(sizeof(struct Int_size) == 8, "");
_Static_assert(_Alignof(struct Int_size) == 1, "");
#endif
...
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 24, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 25, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 26, "");
_Static_assert(_Alignof(struct Y_size) == 1, "");
#endif
_Static_assert(sizeof(Z) == 32, "");
_Static_assert(_Alignof(Z) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Z_alignment) == 40, "");
_Static_assert(_Alignof(struct Z_alignment) == 8, "");
_Static_assert(sizeof(struct Z_packed) == 32, "");
_Static_assert(_Alignof(struct Z_packed) == 1, "");
_Static_assert(sizeof(struct Z_required_alignment) == 33, "");
_Static_assert(_Alignof(struct Z_required_alignment) == 1, "");
_Static_assert(sizeof(struct Z_size) == 34, "");
_Static_assert(_Alignof(struct Z_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
