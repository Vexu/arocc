...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_alignment) == 1, "record B_alignment wrong sizeof");
_Static_assert(_Alignof(struct B_alignment) == 1, "record B_alignment wrong alignment");
_Static_assert(sizeof(struct B_packed) == 0, "record B_packed wrong sizeof");
_Static_assert(_Alignof(struct B_packed) == 1, "record B_packed wrong alignment");
_Static_assert(sizeof(struct B_required_alignment) == 1, "record B_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct B_required_alignment) == 1, "record B_required_alignment wrong alignment");
_Static_assert(sizeof(struct B_size) == 2, "record B_size wrong sizeof");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct J_alignment) == 8, "record J_alignment wrong sizeof");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K_alignment) == 2, "record K_alignment wrong sizeof");
_Static_assert(_Alignof(struct K_alignment) == 2, "record K_alignment wrong alignment");
_Static_assert(sizeof(struct K_packed) == 0, "record K_packed wrong sizeof");
_Static_assert(_Alignof(struct K_packed) == 1, "record K_packed wrong alignment");
_Static_assert(sizeof(struct K_required_alignment) == 1, "record K_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct K_required_alignment) == 1, "record K_required_alignment wrong alignment");
_Static_assert(sizeof(struct K_size) == 2, "record K_size wrong sizeof");
...
_Static_assert(_Alignof(struct G_alignment) == 16, "record G_alignment wrong alignment");
_Static_assert(sizeof(struct G_packed) == 16, "record G_packed wrong sizeof");
_Static_assert(_Alignof(struct G_packed) == 1, "record G_packed wrong alignment");
_Static_assert(sizeof(struct G_required_alignment) == 17, "record G_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "record G_required_alignment wrong alignment");
