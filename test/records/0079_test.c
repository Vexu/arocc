...
_Static_assert(__builtin_bitoffsetof(A,d) == 24, "field A.d wrong bit offset");
#endif
...
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B,i) == 16, "field B.i wrong bit offset");
_Static_assert(__builtin_bitoffsetof(B,d) == 24, "field B.d wrong bit offset");
#endif
...
_Static_assert(sizeof(A) == 7, "record A wrong sizeof");
...
_Static_assert(sizeof(struct A_packed) == 7, "record A_packed wrong sizeof");
_Static_assert(_Alignof(struct A_packed) == 1, "record A_packed wrong alignment");
_Static_assert(sizeof(struct A_required_alignment) == 8, "record A_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct A_required_alignment) == 1, "record A_required_alignment wrong alignment");
_Static_assert(sizeof(struct A_size) == 9, "record A_size wrong sizeof");
_Static_assert(_Alignof(struct A_size) == 1, "record A_size wrong alignment");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A,i) == 16, "field A.i wrong bit offset");
_Static_assert(__builtin_bitoffsetof(A,d) == 48, "field A.d wrong bit offset");
#endif
_Static_assert(sizeof(B) == 7, "record B wrong sizeof");
...
_Static_assert(sizeof(struct B_packed) == 7, "record B_packed wrong sizeof");
_Static_assert(_Alignof(struct B_packed) == 1, "record B_packed wrong alignment");
_Static_assert(sizeof(struct B_required_alignment) == 8, "record B_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct B_required_alignment) == 1, "record B_required_alignment wrong alignment");
_Static_assert(sizeof(struct B_size) == 9, "record B_size wrong sizeof");
_Static_assert(_Alignof(struct B_size) == 1, "record B_size wrong alignment");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B,i) == 16, "field B.i wrong bit offset");
_Static_assert(__builtin_bitoffsetof(B,d) == 48, "field B.d wrong bit offset");
#endif
