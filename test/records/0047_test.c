...
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(X,c) == 16, "field X.c wrong bit offset");
#endif
...
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Y,c) == 8, "field Y.c wrong bit offset");
#endif
...
_Static_assert(__builtin_bitoffsetof(Y,c) == 8, "field Y.c wrong bit offset");
#endif
#elif defined(AARCH64_PC_WINDOWS_MSVC) ||  defined(I586_PC_WINDOWS_MSVC) ||  defined(I686_PC_WINDOWS_GNU) ||  defined(I686_PC_WINDOWS_MSVC) ||  \
 defined(I686_UNKNOWN_WINDOWS) ||  defined(THUMBV7A_PC_WINDOWS_MSVC) ||  defined(X8664_PC_WINDOWS_GNU) ||  defined(X8664_PC_WINDOWS_MSVC) ||  \
...
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Y,c) == 32, "field Y.c wrong bit offset");
#endif
