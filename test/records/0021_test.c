...
_Static_assert(_Alignof(struct Z_alignment) == 16, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Z_alignment) == 24, "");
_Static_assert(_Alignof(struct Z_alignment) == 8, "");
_Static_assert(sizeof(struct Z_packed) == 16, "");
_Static_assert(_Alignof(struct Z_packed) == 1, "");
_Static_assert(sizeof(struct Z_required_alignment) == 17, "");
_Static_assert(_Alignof(struct Z_required_alignment) == 1, "");
_Static_assert(sizeof(struct Z_size) == 18, "");
_Static_assert(_Alignof(struct Z_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
