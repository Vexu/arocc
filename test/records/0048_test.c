...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 129, "");
_Static_assert(_Alignof(struct X_alignment) == 1, "");
_Static_assert(sizeof(struct X_packed) == 128, "");
_Static_assert(_Alignof(struct X_packed) == 1, "");
_Static_assert(sizeof(struct X_required_alignment) == 129, "");
_Static_assert(_Alignof(struct X_required_alignment) == 1, "");
_Static_assert(sizeof(struct X_size) == 130, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 256, "");
_Static_assert(_Alignof(struct X_alignment) == 128, "");
_Static_assert(sizeof(struct X_packed) == 128, "");
_Static_assert(_Alignof(struct X_packed) == 1, "");
_Static_assert(sizeof(struct X_required_alignment) == 129, "");
_Static_assert(_Alignof(struct X_required_alignment) == 1, "");
