...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 56, "");
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 48, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 49, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 50, "");
...
_Static_assert(_Alignof(Y) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 40, "");
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 32, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 33, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 34, "");
_Static_assert(_Alignof(struct Y_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
