...
struct unnamed_type_13_alignment {
#ifdef MSVC
...
struct unnamed_type_13_alignment var15;
#pragma pack(1)
struct unnamed_type_13_packed {
    unnamed_type_13 a;
};
#pragma pack()
struct unnamed_type_13_required_alignment {
#ifdef MSVC
    char a[_Alignof(struct unnamed_type_13_packed)];
    char b;
#else
    char a;
    struct unnamed_type_13_packed b;
#endif
};
struct unnamed_type_13_required_alignment var16;
struct unnamed_type_13_size {
    char a[sizeof(unnamed_type_13)+1];
    char b;
};
struct unnamed_type_13_size var17;
