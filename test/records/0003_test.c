...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 5, "");
_Static_assert(_Alignof(struct Y_alignment) == 1, "");
_Static_assert(sizeof(struct Y_packed) == 4, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 6, "");
...
_Static_assert(_Alignof(struct Y_alignment) == 2, "");
_Static_assert(sizeof(struct Y_packed) == 4, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
