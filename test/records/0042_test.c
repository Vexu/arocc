...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct AlignedStruct_alignment) == 32, "");
_Static_assert(_Alignof(struct AlignedStruct_alignment) == 16, "");
_Static_assert(sizeof(struct AlignedStruct_packed) == 16, "");
_Static_assert(_Alignof(struct AlignedStruct_packed) == 1, "");
_Static_assert(sizeof(struct AlignedStruct_required_alignment) == 17, "");
_Static_assert(_Alignof(struct AlignedStruct_required_alignment) == 1, "");
_Static_assert(sizeof(struct AlignedStruct_size) == 18, "");
_Static_assert(_Alignof(struct AlignedStruct_size) == 1, "");
#endif
_Static_assert(sizeof(AlignedInt) == 4, "");
_Static_assert(_Alignof(AlignedInt) == 16, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct AlignedInt_alignment) == 32, "");
_Static_assert(_Alignof(struct AlignedInt_alignment) == 16, "");
_Static_assert(sizeof(struct AlignedInt_packed) == 4, "");
_Static_assert(_Alignof(struct AlignedInt_packed) == 1, "");
_Static_assert(sizeof(struct AlignedInt_required_alignment) == 5, "");
_Static_assert(_Alignof(struct AlignedInt_required_alignment) == 1, "");
_Static_assert(sizeof(struct AlignedInt_size) == 6, "");
_Static_assert(_Alignof(struct AlignedInt_size) == 1, "");
#endif
_Static_assert(sizeof(A) == 16, "");
_Static_assert(_Alignof(A) == 2, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A_alignment) == 18, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_alignment) == 20, "");
_Static_assert(_Alignof(struct B_alignment) == 2, "");
_Static_assert(sizeof(struct B_packed) == 18, "");
_Static_assert(_Alignof(struct B_packed) == 1, "");
_Static_assert(sizeof(struct B_required_alignment) == 19, "");
_Static_assert(_Alignof(struct B_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_size) == 20, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_alignment) == 48, "");
_Static_assert(_Alignof(struct B_alignment) == 16, "");
_Static_assert(sizeof(struct B_packed) == 32, "");
_Static_assert(_Alignof(struct B_packed) == 1, "");
_Static_assert(sizeof(struct B_required_alignment) == 33, "");
_Static_assert(_Alignof(struct B_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_size) == 34, "");
_Static_assert(_Alignof(struct B_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(sizeof(struct AlignedInt_alignment) == 32, "");
_Static_assert(_Alignof(struct AlignedInt_alignment) == 16, "");
_Static_assert(sizeof(struct AlignedInt_packed) == 2, "");
_Static_assert(_Alignof(struct AlignedInt_packed) == 1, "");
_Static_assert(sizeof(struct AlignedInt_required_alignment) == 3, "");
_Static_assert(_Alignof(struct AlignedInt_required_alignment) == 1, "");
_Static_assert(sizeof(struct AlignedInt_size) == 4, "");
_Static_assert(_Alignof(struct AlignedInt_size) == 1, "");
#endif
_Static_assert(sizeof(A) == 16, "");
_Static_assert(_Alignof(A) == 2, "");
