...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C_alignment) == 130, "record C_alignment wrong sizeof");
_Static_assert(_Alignof(struct C_alignment) == 1, "record C_alignment wrong alignment");
_Static_assert(sizeof(struct C_packed) == 129, "record C_packed wrong sizeof");
_Static_assert(_Alignof(struct C_packed) == 1, "record C_packed wrong alignment");
_Static_assert(sizeof(struct C_required_alignment) == 130, "record C_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct C_required_alignment) == 1, "record C_required_alignment wrong alignment");
_Static_assert(sizeof(struct C_size) == 131, "record C_size wrong sizeof");
...
_Static_assert(__builtin_bitoffsetof(C,d) == 1024, "field C.d wrong bit offset");
 ...
 defined(ARMV7_UNKNOWN_NETBSDELF_EABIHF) ||  defined(I586_PC_WINDOWS_MSVC) ||  defined(I686_PC_WINDOWS_GNU) ||  defined(I686_PC_WINDOWS_MSVC) ||  \
 defined(I686_UNKNOWN_WINDOWS) ||  defined(THUMBV4T_NONE_EABI) ||  defined(THUMBV6M_NONE_EABI) ||  defined(THUMBV7EM_NONE_EABIHF) ||  \
 defined(THUMBV7EM_NONE_EABI) ||  defined(THUMBV7M_NONE_EABI) ||  defined(THUMBV8MBASE_NONE_EABI) ||  defined(THUMBV8MMAIN_NONE_EABIHF) ||  \
 defined(THUMBV8MMAIN_NONE_EABI) ||  defined(X8664_PC_WINDOWS_GNU) ||  defined(X8664_PC_WINDOWS_MSVC) ||  defined(X8664_UNKNOWN_WINDOWS) 
...
_Static_assert(_Alignof(C) == 128, "record C wrong alignment");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C_alignment) == 264, "record C_alignment wrong sizeof");
_Static_assert(_Alignof(struct C_alignment) == 128, "record C_alignment wrong alignment");
_Static_assert(sizeof(struct C_packed) == 136, "record C_packed wrong sizeof");
_Static_assert(_Alignof(struct C_packed) == 1, "record C_packed wrong alignment");
_Static_assert(sizeof(struct C_required_alignment) == 137, "record C_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct C_required_alignment) == 1, "record C_required_alignment wrong alignment");
_Static_assert(sizeof(struct C_size) == 138, "record C_size wrong sizeof");
_Static_assert(_Alignof(struct C_size) == 1, "record C_size wrong alignment");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C,d) == 1024, "field C.d wrong bit offset");
