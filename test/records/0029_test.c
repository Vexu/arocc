...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D_alignment) == 5, "");
...
_Static_assert(_Alignof(struct H_size) == 1, "");
#endif
// MAPPING|THREE|arm-cortex_r4-ios-none:Clang|arm-baseline-ios-none:Clang|avr-atmega328-other-gnu:Gcc|END
// repr targets Armv7AppleIos|Some("arm-cortex_r4-ios-none") Armv7sAppleIos|Some("arm-baseline-ios-none") AvrUnknownUnknown|Some("avr-atmega328-other-gnu") 
#elif defined(THREE)
_Static_assert(sizeof(Char) == 1, "");
_Static_assert(_Alignof(Char) == 4, "");
#ifdef EXTRA_TESTS
