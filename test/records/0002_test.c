...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 10, "");
