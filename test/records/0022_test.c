...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S4_alignment) == 2, "");
_Static_assert(_Alignof(struct S4_alignment) == 1, "");
_Static_assert(sizeof(struct S4_packed) == 1, "");
_Static_assert(_Alignof(struct S4_packed) == 1, "");
_Static_assert(sizeof(struct S4_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S4_required_alignment) == 1, "");
_Static_assert(sizeof(struct S4_size) == 3, "");
_Static_assert(_Alignof(struct S4_size) == 1, "");
#endif
_Static_assert(sizeof(S8) == 1, "");
_Static_assert(_Alignof(S8) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S8_alignment) == 2, "");
_Static_assert(_Alignof(struct S8_alignment) == 1, "");
_Static_assert(sizeof(struct S8_packed) == 1, "");
_Static_assert(_Alignof(struct S8_packed) == 1, "");
_Static_assert(sizeof(struct S8_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S8_required_alignment) == 1, "");
_Static_assert(sizeof(struct S8_size) == 3, "");
_Static_assert(_Alignof(struct S8_size) == 1, "");
#endif
_Static_assert(sizeof(S16) == 1, "");
_Static_assert(_Alignof(S16) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S16_alignment) == 2, "");
_Static_assert(_Alignof(struct S16_alignment) == 1, "");
_Static_assert(sizeof(struct S16_packed) == 1, "");
_Static_assert(_Alignof(struct S16_packed) == 1, "");
_Static_assert(sizeof(struct S16_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S16_required_alignment) == 1, "");
_Static_assert(sizeof(struct S16_size) == 3, "");
_Static_assert(_Alignof(struct S16_size) == 1, "");
#endif
_Static_assert(sizeof(S32) == 1, "");
_Static_assert(_Alignof(S32) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S32_alignment) == 2, "");
_Static_assert(_Alignof(struct S32_alignment) == 1, "");
_Static_assert(sizeof(struct S32_packed) == 1, "");
_Static_assert(_Alignof(struct S32_packed) == 1, "");
_Static_assert(sizeof(struct S32_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S32_required_alignment) == 1, "");
_Static_assert(sizeof(struct S32_size) == 3, "");
_Static_assert(_Alignof(struct S32_size) == 1, "");
#endif
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S4_alignment) == 8, "");
_Static_assert(_Alignof(struct S4_alignment) == 4, "");
_Static_assert(sizeof(struct S4_packed) == 1, "");
_Static_assert(_Alignof(struct S4_packed) == 1, "");
_Static_assert(sizeof(struct S4_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S4_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S8_alignment) == 16, "");
_Static_assert(_Alignof(struct S8_alignment) == 8, "");
_Static_assert(sizeof(struct S8_packed) == 1, "");
_Static_assert(_Alignof(struct S8_packed) == 1, "");
_Static_assert(sizeof(struct S8_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S8_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S16_alignment) == 32, "");
_Static_assert(_Alignof(struct S16_alignment) == 16, "");
_Static_assert(sizeof(struct S16_packed) == 1, "");
_Static_assert(_Alignof(struct S16_packed) == 1, "");
_Static_assert(sizeof(struct S16_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S16_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S32_alignment) == 64, "");
_Static_assert(_Alignof(struct S32_alignment) == 32, "");
_Static_assert(sizeof(struct S32_packed) == 1, "");
_Static_assert(_Alignof(struct S32_packed) == 1, "");
_Static_assert(sizeof(struct S32_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S32_required_alignment) == 1, "");
