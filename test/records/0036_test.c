...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 2, "");
_Static_assert(_Alignof(struct S_alignment) == 1, "");
_Static_assert(sizeof(struct S_packed) == 1, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 3, "");
