...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A1_alignment) == 13, "");
_Static_assert(_Alignof(struct A1_alignment) == 1, "");
_Static_assert(sizeof(struct A1_packed) == 12, "");
_Static_assert(_Alignof(struct A1_packed) == 1, "");
_Static_assert(sizeof(struct A1_required_alignment) == 13, "");
_Static_assert(_Alignof(struct A1_required_alignment) == 1, "");
_Static_assert(sizeof(struct A1_size) == 14, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A2_alignment) == 13, "");
_Static_assert(_Alignof(struct A2_alignment) == 1, "");
_Static_assert(sizeof(struct A2_packed) == 12, "");
_Static_assert(_Alignof(struct A2_packed) == 1, "");
_Static_assert(sizeof(struct A2_required_alignment) == 13, "");
_Static_assert(_Alignof(struct A2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A2_size) == 14, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B1_alignment) == 9, "");
_Static_assert(_Alignof(struct B1_alignment) == 1, "");
_Static_assert(sizeof(struct B1_packed) == 8, "");
_Static_assert(_Alignof(struct B1_packed) == 1, "");
_Static_assert(sizeof(struct B1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct B1_required_alignment) == 1, "");
_Static_assert(sizeof(struct B1_size) == 10, "");
_Static_assert(_Alignof(struct B1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B2_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C1_alignment) == 10, "");
_Static_assert(_Alignof(struct C1_alignment) == 1, "");
_Static_assert(sizeof(struct C1_packed) == 9, "");
_Static_assert(_Alignof(struct C1_packed) == 1, "");
_Static_assert(sizeof(struct C1_required_alignment) == 10, "");
_Static_assert(_Alignof(struct C1_required_alignment) == 1, "");
_Static_assert(sizeof(struct C1_size) == 11, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C2_alignment) == 10, "");
_Static_assert(_Alignof(struct C2_alignment) == 1, "");
_Static_assert(sizeof(struct C2_packed) == 9, "");
_Static_assert(_Alignof(struct C2_packed) == 1, "");
_Static_assert(sizeof(struct C2_required_alignment) == 10, "");
_Static_assert(_Alignof(struct C2_required_alignment) == 1, "");
_Static_assert(sizeof(struct C2_size) == 11, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D1_alignment) == 9, "");
_Static_assert(_Alignof(struct D1_alignment) == 1, "");
_Static_assert(sizeof(struct D1_packed) == 8, "");
_Static_assert(_Alignof(struct D1_packed) == 1, "");
_Static_assert(sizeof(struct D1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct D1_required_alignment) == 1, "");
_Static_assert(sizeof(struct D1_size) == 10, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E1_alignment) == 9, "");
_Static_assert(_Alignof(struct E1_alignment) == 1, "");
_Static_assert(sizeof(struct E1_packed) == 8, "");
_Static_assert(_Alignof(struct E1_packed) == 1, "");
_Static_assert(sizeof(struct E1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct E1_required_alignment) == 1, "");
_Static_assert(sizeof(struct E1_size) == 10, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E2_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F1_alignment) == 9, "");
_Static_assert(_Alignof(struct F1_alignment) == 1, "");
_Static_assert(sizeof(struct F1_packed) == 8, "");
_Static_assert(_Alignof(struct F1_packed) == 1, "");
_Static_assert(sizeof(struct F1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct F1_required_alignment) == 1, "");
_Static_assert(sizeof(struct F1_size) == 10, "");
_Static_assert(_Alignof(struct F1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F2_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E1_alignment) == 12, "");
_Static_assert(_Alignof(struct E1_alignment) == 4, "");
_Static_assert(sizeof(struct E1_packed) == 8, "");
_Static_assert(_Alignof(struct E1_packed) == 1, "");
_Static_assert(sizeof(struct E1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct E1_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E2_alignment) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F1_alignment) == 12, "");
_Static_assert(_Alignof(struct F1_alignment) == 4, "");
_Static_assert(sizeof(struct F1_packed) == 8, "");
_Static_assert(_Alignof(struct F1_packed) == 1, "");
_Static_assert(sizeof(struct F1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct F1_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F2_alignment) == 12, "");
...
_Static_assert(_Alignof(A1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A1_alignment) == 9, "");
_Static_assert(_Alignof(struct A1_alignment) == 1, "");
_Static_assert(sizeof(struct A1_packed) == 8, "");
_Static_assert(_Alignof(struct A1_packed) == 1, "");
_Static_assert(sizeof(struct A1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct A1_required_alignment) == 1, "");
_Static_assert(sizeof(struct A1_size) == 10, "");
_Static_assert(_Alignof(struct A1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A1,y) == 32, "");
...
_Static_assert(_Alignof(B1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B1_alignment) == 5, "");
_Static_assert(_Alignof(struct B1_alignment) == 1, "");
_Static_assert(sizeof(struct B1_packed) == 4, "");
_Static_assert(_Alignof(struct B1_packed) == 1, "");
_Static_assert(sizeof(struct B1_required_alignment) == 5, "");
_Static_assert(_Alignof(struct B1_required_alignment) == 1, "");
_Static_assert(sizeof(struct B1_size) == 6, "");
_Static_assert(_Alignof(struct B1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B1,y) == 0, "");
...
_Static_assert(_Alignof(B2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B2_alignment) == 5, "");
_Static_assert(_Alignof(struct B2_alignment) == 1, "");
...
_Static_assert(_Alignof(C1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C1_alignment) == 6, "");
_Static_assert(_Alignof(struct C1_alignment) == 1, "");
_Static_assert(sizeof(struct C1_packed) == 5, "");
_Static_assert(_Alignof(struct C1_packed) == 1, "");
_Static_assert(sizeof(struct C1_required_alignment) == 6, "");
_Static_assert(_Alignof(struct C1_required_alignment) == 1, "");
_Static_assert(sizeof(struct C1_size) == 7, "");
_Static_assert(_Alignof(struct C1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C1,y) == 8, "");
...
_Static_assert(_Alignof(C2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C2_alignment) == 6, "");
_Static_assert(_Alignof(struct C2_alignment) == 1, "");
_Static_assert(sizeof(struct C2_packed) == 5, "");
_Static_assert(_Alignof(struct C2_packed) == 1, "");
_Static_assert(sizeof(struct C2_required_alignment) == 6, "");
_Static_assert(_Alignof(struct C2_required_alignment) == 1, "");
_Static_assert(sizeof(struct C2_size) == 7, "");
_Static_assert(_Alignof(struct C2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C2,y) == 8, "");
...
_Static_assert(_Alignof(D1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D1_alignment) == 5, "");
_Static_assert(_Alignof(struct D1_alignment) == 1, "");
_Static_assert(sizeof(struct D1_packed) == 4, "");
_Static_assert(_Alignof(struct D1_packed) == 1, "");
_Static_assert(sizeof(struct D1_required_alignment) == 5, "");
_Static_assert(_Alignof(struct D1_required_alignment) == 1, "");
_Static_assert(sizeof(struct D1_size) == 6, "");
_Static_assert(_Alignof(struct D1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(D1,y) == 0, "");
...
_Static_assert(_Alignof(D2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D2_alignment) == 5, "");
_Static_assert(_Alignof(struct D2_alignment) == 1, "");
_Static_assert(sizeof(struct D2_packed) == 4, "");
_Static_assert(_Alignof(struct D2_packed) == 1, "");
_Static_assert(sizeof(struct D2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct D2_required_alignment) == 1, "");
_Static_assert(sizeof(struct D2_size) == 6, "");
_Static_assert(_Alignof(struct D2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(D2,y) == 0, "");
...
_Static_assert(_Alignof(E1) == 4, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E1_alignment) == 8, "");
_Static_assert(_Alignof(struct E1_alignment) == 4, "");
_Static_assert(sizeof(struct E1_packed) == 4, "");
_Static_assert(_Alignof(struct E1_packed) == 1, "");
_Static_assert(sizeof(struct E1_required_alignment) == 5, "");
_Static_assert(_Alignof(struct E1_required_alignment) == 1, "");
_Static_assert(sizeof(struct E1_size) == 6, "");
_Static_assert(_Alignof(struct E1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(E1,y) == 0, "");
...
_Static_assert(_Alignof(F1) == 4, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F1_alignment) == 8, "");
_Static_assert(_Alignof(struct F1_alignment) == 4, "");
_Static_assert(sizeof(struct F1_packed) == 4, "");
_Static_assert(_Alignof(struct F1_packed) == 1, "");
_Static_assert(sizeof(struct F1_required_alignment) == 5, "");
_Static_assert(_Alignof(struct F1_required_alignment) == 1, "");
_Static_assert(sizeof(struct F1_size) == 6, "");
_Static_assert(_Alignof(struct F1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(F1,y) == 0, "");
...
_Static_assert(_Alignof(A1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A1_alignment) == 7, "");
_Static_assert(_Alignof(struct A1_alignment) == 1, "");
_Static_assert(sizeof(struct A1_packed) == 6, "");
_Static_assert(_Alignof(struct A1_packed) == 1, "");
_Static_assert(sizeof(struct A1_required_alignment) == 7, "");
_Static_assert(_Alignof(struct A1_required_alignment) == 1, "");
_Static_assert(sizeof(struct A1_size) == 8, "");
_Static_assert(_Alignof(struct A1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(A2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A2_alignment) == 7, "");
_Static_assert(_Alignof(struct A2_alignment) == 1, "");
_Static_assert(sizeof(struct A2_packed) == 6, "");
_Static_assert(_Alignof(struct A2_packed) == 1, "");
_Static_assert(sizeof(struct A2_required_alignment) == 7, "");
_Static_assert(_Alignof(struct A2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A2_size) == 8, "");
_Static_assert(_Alignof(struct A2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(E1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E1_alignment) == 5, "");
_Static_assert(_Alignof(struct E1_alignment) == 1, "");
_Static_assert(sizeof(struct E1_packed) == 4, "");
_Static_assert(_Alignof(struct E1_packed) == 1, "");
_Static_assert(sizeof(struct E1_required_alignment) == 5, "");
...
_Static_assert(_Alignof(E2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E2_alignment) == 5, "");
_Static_assert(_Alignof(struct E2_alignment) == 1, "");
_Static_assert(sizeof(struct E2_packed) == 4, "");
_Static_assert(_Alignof(struct E2_packed) == 1, "");
_Static_assert(sizeof(struct E2_required_alignment) == 5, "");
...
_Static_assert(_Alignof(F1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F1_alignment) == 5, "");
_Static_assert(_Alignof(struct F1_alignment) == 1, "");
_Static_assert(sizeof(struct F1_packed) == 4, "");
_Static_assert(_Alignof(struct F1_packed) == 1, "");
_Static_assert(sizeof(struct F1_required_alignment) == 5, "");
...
_Static_assert(_Alignof(F2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F2_alignment) == 5, "");
_Static_assert(_Alignof(struct F2_alignment) == 1, "");
_Static_assert(sizeof(struct F2_packed) == 4, "");
_Static_assert(_Alignof(struct F2_packed) == 1, "");
_Static_assert(sizeof(struct F2_required_alignment) == 5, "");
...
_Static_assert(_Alignof(C1) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C1_alignment) == 9, "");
_Static_assert(_Alignof(struct C1_alignment) == 1, "");
_Static_assert(sizeof(struct C1_packed) == 8, "");
_Static_assert(_Alignof(struct C1_packed) == 1, "");
_Static_assert(sizeof(struct C1_required_alignment) == 9, "");
_Static_assert(_Alignof(struct C1_required_alignment) == 1, "");
_Static_assert(sizeof(struct C1_size) == 10, "");
_Static_assert(_Alignof(struct C1_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(C2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C2_alignment) == 9, "");
_Static_assert(_Alignof(struct C2_alignment) == 1, "");
