...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_alignment) == 32, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C_alignment) == 48, "");
_Static_assert(_Alignof(struct C_alignment) == 16, "");
_Static_assert(sizeof(struct C_packed) == 32, "");
_Static_assert(_Alignof(struct C_packed) == 1, "");
_Static_assert(sizeof(struct C_required_alignment) == 33, "");
_Static_assert(_Alignof(struct C_required_alignment) == 1, "");
_Static_assert(sizeof(struct C_size) == 34, "");
...
_Static_assert(sizeof(struct G_packed) == 14, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 15, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 16, "");
...
_Static_assert(sizeof(struct C_alignment) == 48, "");
_Static_assert(_Alignof(struct C_alignment) == 16, "");
_Static_assert(sizeof(struct C_packed) == 24, "");
_Static_assert(_Alignof(struct C_packed) == 1, "");
_Static_assert(sizeof(struct C_required_alignment) == 25, "");
_Static_assert(_Alignof(struct C_required_alignment) == 1, "");
_Static_assert(sizeof(struct C_size) == 26, "");
_Static_assert(_Alignof(struct C_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C,a) == 128, "");
...
_Static_assert(_Alignof(B) == 16, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_alignment) == 64, "");
_Static_assert(_Alignof(struct B_alignment) == 16, "");
_Static_assert(sizeof(struct B_packed) == 48, "");
_Static_assert(_Alignof(struct B_packed) == 1, "");
_Static_assert(sizeof(struct B_required_alignment) == 49, "");
_Static_assert(_Alignof(struct B_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_size) == 50, "");
_Static_assert(_Alignof(struct B_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(sizeof(struct E_packed) == 5, "");
_Static_assert(_Alignof(struct E_packed) == 1, "");
_Static_assert(sizeof(struct E_required_alignment) == 6, "");
_Static_assert(_Alignof(struct E_required_alignment) == 1, "");
_Static_assert(sizeof(struct E_size) == 7, "");
_Static_assert(_Alignof(struct E_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(sizeof(struct G_packed) == 13, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 14, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 15, "");
_Static_assert(_Alignof(struct G_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(G,b) == 8, "");
...
_Static_assert(_Alignof(G) == 2, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G_alignment) == 20, "");
_Static_assert(_Alignof(struct G_alignment) == 2, "");
_Static_assert(sizeof(struct G_packed) == 18, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 19, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 20, "");
_Static_assert(_Alignof(struct G_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
