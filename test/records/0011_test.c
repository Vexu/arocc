...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I1_alignment) == 16, "");
_Static_assert(_Alignof(struct I1_alignment) == 8, "");
_Static_assert(sizeof(struct I1_packed) == 4, "");
_Static_assert(_Alignof(struct I1_packed) == 1, "");
_Static_assert(sizeof(struct I1_required_alignment) == 5, "");
_Static_assert(_Alignof(struct I1_required_alignment) == 1, "");
_Static_assert(sizeof(struct I1_size) == 6, "");
_Static_assert(_Alignof(struct I1_size) == 1, "");
#endif
_Static_assert(sizeof(I2) == 4, "");
_Static_assert(_Alignof(I2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I2_alignment) == 5, "");
_Static_assert(_Alignof(struct I2_alignment) == 1, "");
_Static_assert(sizeof(struct I2_packed) == 4, "");
_Static_assert(_Alignof(struct I2_packed) == 1, "");
_Static_assert(sizeof(struct I2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct I2_required_alignment) == 1, "");
_Static_assert(sizeof(struct I2_size) == 6, "");
_Static_assert(_Alignof(struct I2_size) == 1, "");
#endif
_Static_assert(sizeof(X) == 4, "");
_Static_assert(_Alignof(X) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 5, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I2_alignment) == 16, "");
_Static_assert(_Alignof(struct I2_alignment) == 8, "");
_Static_assert(sizeof(struct I2_packed) == 4, "");
_Static_assert(_Alignof(struct I2_packed) == 1, "");
_Static_assert(sizeof(struct I2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct I2_required_alignment) == 1, "");
...
_Static_assert(sizeof(struct I1_alignment) == 16, "");
_Static_assert(_Alignof(struct I1_alignment) == 8, "");
_Static_assert(sizeof(struct I1_packed) == 2, "");
_Static_assert(_Alignof(struct I1_packed) == 1, "");
_Static_assert(sizeof(struct I1_required_alignment) == 3, "");
_Static_assert(_Alignof(struct I1_required_alignment) == 1, "");
_Static_assert(sizeof(struct I1_size) == 4, "");
_Static_assert(_Alignof(struct I1_size) == 1, "");
#endif
_Static_assert(sizeof(I2) == 2, "");
_Static_assert(_Alignof(I2) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I2_alignment) == 3, "");
_Static_assert(_Alignof(struct I2_alignment) == 1, "");
_Static_assert(sizeof(struct I2_packed) == 2, "");
_Static_assert(_Alignof(struct I2_packed) == 1, "");
_Static_assert(sizeof(struct I2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct I2_required_alignment) == 1, "");
_Static_assert(sizeof(struct I2_size) == 4, "");
_Static_assert(_Alignof(struct I2_size) == 1, "");
#endif
