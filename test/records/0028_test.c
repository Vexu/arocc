...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Char_alignment) == 8, "");
_Static_assert(_Alignof(struct Char_alignment) == 4, "");
_Static_assert(sizeof(struct Char_packed) == 1, "");
...
_Static_assert(sizeof(struct Char_size) == 3, "");
_Static_assert(_Alignof(struct Char_size) == 1, "");
#endif
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct E_alignment) == 24, "");
...
_Static_assert(sizeof(struct F_packed) == 5, "");
_Static_assert(_Alignof(struct F_packed) == 1, "");
_Static_assert(sizeof(struct F_required_alignment) == 6, "");
_Static_assert(_Alignof(struct F_required_alignment) == 1, "");
_Static_assert(sizeof(struct F_size) == 7, "");
_Static_assert(_Alignof(struct F_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(sizeof(struct G_packed) == 9, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 10, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 11, "");
_Static_assert(_Alignof(struct G_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
