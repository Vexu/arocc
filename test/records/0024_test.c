...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 8, "");
...
_Static_assert(_Alignof(Y) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 2, "");
_Static_assert(_Alignof(struct Y_alignment) == 1, "");
_Static_assert(sizeof(struct Y_packed) == 1, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 2, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 3, "");
_Static_assert(_Alignof(struct Y_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Y,b) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 1, "");
