...
#endif
_Static_assert(sizeof(Y) == 4, "record Y wrong sizeof");
_Static_assert(_Alignof(Y) == 1, "record Y wrong alignment");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 5, "record Y_alignment wrong sizeof");
_Static_assert(_Alignof(struct Y_alignment) == 1, "record Y_alignment wrong alignment");
_Static_assert(sizeof(struct Y_packed) == 4, "record Y_packed wrong sizeof");
_Static_assert(_Alignof(struct Y_packed) == 1, "record Y_packed wrong alignment");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "record Y_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "record Y_required_alignment wrong alignment");
_Static_assert(sizeof(struct Y_size) == 6, "record Y_size wrong sizeof");
...
#endif
_Static_assert(sizeof(Y) == 4, "record Y wrong sizeof");
_Static_assert(_Alignof(Y) == 2, "record Y wrong alignment");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 6, "record Y_alignment wrong sizeof");
_Static_assert(_Alignof(struct Y_alignment) == 2, "record Y_alignment wrong alignment");
_Static_assert(sizeof(struct Y_packed) == 4, "record Y_packed wrong sizeof");
_Static_assert(_Alignof(struct Y_packed) == 1, "record Y_packed wrong alignment");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "record Y_required_alignment wrong sizeof");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "record Y_required_alignment wrong alignment");
