...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 5, "record Y wrong sizeof");
_Static_assert(_Alignof(struct Y_alignment) == 1, "record Y wrong alignment");
_Static_assert(sizeof(struct Y_packed) == 4, "record Y wrong sizeof");
_Static_assert(_Alignof(struct Y_packed) == 1, "record Y wrong alignment");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "record Y wrong sizeof");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "record Y wrong alignment");
_Static_assert(sizeof(struct Y_size) == 6, "record Y wrong sizeof");
...
_Static_assert(_Alignof(struct Y_alignment) == 2, "record Y wrong alignment");
_Static_assert(sizeof(struct Y_packed) == 4, "record Y wrong sizeof");
_Static_assert(_Alignof(struct Y_packed) == 1, "record Y wrong alignment");
_Static_assert(sizeof(struct Y_required_alignment) == 5, "record Y wrong sizeof");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "record Y wrong alignment");
