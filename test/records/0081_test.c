...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G_alignment) == 12, "");
_Static_assert(_Alignof(struct G_alignment) == 2, "");
_Static_assert(sizeof(struct G_packed) == 10, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 11, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G_alignment) == 11, "");
...
_Static_assert(_Alignof(G) == 2, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G_alignment) == 18, "");
_Static_assert(_Alignof(struct G_alignment) == 2, "");
_Static_assert(sizeof(struct G_packed) == 16, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 17, "");
