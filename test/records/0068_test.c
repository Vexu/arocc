...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A__alignment) == 6, "");
_Static_assert(_Alignof(struct A__alignment) == 1, "");
_Static_assert(sizeof(struct A__packed) == 5, "");
_Static_assert(_Alignof(struct A__packed) == 1, "");
_Static_assert(sizeof(struct A__required_alignment) == 6, "");
_Static_assert(_Alignof(struct A__required_alignment) == 1, "");
_Static_assert(sizeof(struct A__size) == 7, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B__alignment) == 10, "");
_Static_assert(_Alignof(struct B__alignment) == 1, "");
_Static_assert(sizeof(struct B__packed) == 9, "");
_Static_assert(_Alignof(struct B__packed) == 1, "");
_Static_assert(sizeof(struct B__required_alignment) == 10, "");
_Static_assert(_Alignof(struct B__required_alignment) == 1, "");
_Static_assert(sizeof(struct B__size) == 11, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 10, "");
_Static_assert(_Alignof(struct C__alignment) == 1, "");
_Static_assert(sizeof(struct C__packed) == 9, "");
_Static_assert(_Alignof(struct C__packed) == 1, "");
_Static_assert(sizeof(struct C__required_alignment) == 10, "");
_Static_assert(_Alignof(struct C__required_alignment) == 1, "");
_Static_assert(sizeof(struct C__size) == 11, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D_alignment) == 32, "");
_Static_assert(_Alignof(struct D_alignment) == 8, "");
_Static_assert(sizeof(struct D_packed) == 24, "");
_Static_assert(_Alignof(struct D_packed) == 1, "");
_Static_assert(sizeof(struct D_required_alignment) == 25, "");
_Static_assert(_Alignof(struct D_required_alignment) == 1, "");
_Static_assert(sizeof(struct D_size) == 26, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F_alignment) == 48, "");
_Static_assert(_Alignof(struct F_alignment) == 16, "");
_Static_assert(sizeof(struct F_packed) == 32, "");
_Static_assert(_Alignof(struct F_packed) == 1, "");
_Static_assert(sizeof(struct F_required_alignment) == 33, "");
_Static_assert(_Alignof(struct F_required_alignment) == 1, "");
_Static_assert(sizeof(struct F_size) == 34, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G_alignment) == 14, "");
_Static_assert(_Alignof(struct G_alignment) == 2, "");
_Static_assert(sizeof(struct G_packed) == 12, "");
_Static_assert(_Alignof(struct G_packed) == 1, "");
_Static_assert(sizeof(struct G_required_alignment) == 13, "");
_Static_assert(_Alignof(struct G_required_alignment) == 1, "");
_Static_assert(sizeof(struct G_size) == 14, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct H_alignment) == 14, "");
_Static_assert(_Alignof(struct H_alignment) == 2, "");
_Static_assert(sizeof(struct H_packed) == 12, "");
_Static_assert(_Alignof(struct H_packed) == 1, "");
_Static_assert(sizeof(struct H_required_alignment) == 13, "");
_Static_assert(_Alignof(struct H_required_alignment) == 1, "");
_Static_assert(sizeof(struct H_size) == 14, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I_alignment) == 11, "");
_Static_assert(_Alignof(struct I_alignment) == 1, "");
_Static_assert(sizeof(struct I_packed) == 10, "");
_Static_assert(_Alignof(struct I_packed) == 1, "");
_Static_assert(sizeof(struct I_required_alignment) == 11, "");
_Static_assert(_Alignof(struct I_required_alignment) == 1, "");
_Static_assert(sizeof(struct I_size) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct J_alignment) == 14, "");
_Static_assert(_Alignof(struct J_alignment) == 2, "");
_Static_assert(sizeof(struct J_packed) == 12, "");
_Static_assert(_Alignof(struct J_packed) == 1, "");
_Static_assert(sizeof(struct J_required_alignment) == 13, "");
_Static_assert(_Alignof(struct J_required_alignment) == 1, "");
_Static_assert(sizeof(struct J_size) == 14, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct L_alignment) == 48, "");
_Static_assert(_Alignof(struct L_alignment) == 16, "");
_Static_assert(sizeof(struct L_packed) == 32, "");
_Static_assert(_Alignof(struct L_packed) == 1, "");
_Static_assert(sizeof(struct L_required_alignment) == 33, "");
_Static_assert(_Alignof(struct L_required_alignment) == 1, "");
_Static_assert(sizeof(struct L_size) == 34, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct N_alignment) == 6, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct O_alignment) == 4, "");
_Static_assert(_Alignof(struct O_alignment) == 1, "");
_Static_assert(sizeof(struct O_packed) == 3, "");
_Static_assert(_Alignof(struct O_packed) == 1, "");
_Static_assert(sizeof(struct O_required_alignment) == 4, "");
_Static_assert(_Alignof(struct O_required_alignment) == 1, "");
_Static_assert(sizeof(struct O_size) == 5, "");
_Static_assert(_Alignof(struct O_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct P_alignment) == 6, "");
_Static_assert(_Alignof(struct P_alignment) == 2, "");
_Static_assert(sizeof(struct P_packed) == 4, "");
_Static_assert(_Alignof(struct P_packed) == 1, "");
_Static_assert(sizeof(struct P_required_alignment) == 5, "");
_Static_assert(_Alignof(struct P_required_alignment) == 1, "");
_Static_assert(sizeof(struct P_size) == 6, "");
_Static_assert(_Alignof(struct P_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q_alignment) == 16, "");
_Static_assert(_Alignof(struct Q_alignment) == 8, "");
_Static_assert(sizeof(struct Q_packed) == 8, "");
_Static_assert(_Alignof(struct Q_packed) == 1, "");
_Static_assert(sizeof(struct Q_required_alignment) == 9, "");
_Static_assert(_Alignof(struct Q_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q_size) == 10, "");
_Static_assert(_Alignof(struct Q_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct R_alignment) == 18, "");
_Static_assert(_Alignof(struct R_alignment) == 1, "");
_Static_assert(sizeof(struct R_packed) == 17, "");
_Static_assert(_Alignof(struct R_packed) == 1, "");
_Static_assert(sizeof(struct R_required_alignment) == 18, "");
_Static_assert(_Alignof(struct R_required_alignment) == 1, "");
_Static_assert(sizeof(struct R_size) == 19, "");
_Static_assert(_Alignof(struct R_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 10, "");
_Static_assert(_Alignof(struct S_alignment) == 1, "");
_Static_assert(sizeof(struct S_packed) == 9, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 10, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 11, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T_alignment) == 10, "");
_Static_assert(_Alignof(struct T_alignment) == 1, "");
_Static_assert(sizeof(struct T_packed) == 9, "");
_Static_assert(_Alignof(struct T_packed) == 1, "");
_Static_assert(sizeof(struct T_required_alignment) == 10, "");
_Static_assert(_Alignof(struct T_required_alignment) == 1, "");
_Static_assert(sizeof(struct T_size) == 11, "");
_Static_assert(_Alignof(struct T_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 10, "");
_Static_assert(_Alignof(struct U_alignment) == 1, "");
_Static_assert(sizeof(struct U_packed) == 9, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 10, "");
_Static_assert(_Alignof(struct U_required_alignment) == 1, "");
_Static_assert(sizeof(struct U_size) == 11, "");
_Static_assert(_Alignof(struct U_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 10, "");
_Static_assert(_Alignof(struct V_alignment) == 1, "");
_Static_assert(sizeof(struct V_packed) == 9, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 10, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 11, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W_alignment) == 18, "");
_Static_assert(_Alignof(struct W_alignment) == 1, "");
_Static_assert(sizeof(struct W_packed) == 17, "");
_Static_assert(_Alignof(struct W_packed) == 1, "");
_Static_assert(sizeof(struct W_required_alignment) == 18, "");
_Static_assert(_Alignof(struct W_required_alignment) == 1, "");
_Static_assert(sizeof(struct W_size) == 19, "");
_Static_assert(_Alignof(struct W_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W__alignment) == 18, "");
_Static_assert(_Alignof(struct W__alignment) == 1, "");
_Static_assert(sizeof(struct W__packed) == 17, "");
_Static_assert(_Alignof(struct W__packed) == 1, "");
_Static_assert(sizeof(struct W__required_alignment) == 18, "");
_Static_assert(_Alignof(struct W__required_alignment) == 1, "");
_Static_assert(sizeof(struct W__size) == 19, "");
_Static_assert(_Alignof(struct W__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 18, "");
_Static_assert(_Alignof(struct X_alignment) == 1, "");
_Static_assert(sizeof(struct X_packed) == 17, "");
_Static_assert(_Alignof(struct X_packed) == 1, "");
_Static_assert(sizeof(struct X_required_alignment) == 18, "");
_Static_assert(_Alignof(struct X_required_alignment) == 1, "");
_Static_assert(sizeof(struct X_size) == 19, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A2_alignment) == 2, "");
_Static_assert(_Alignof(struct A2_alignment) == 1, "");
_Static_assert(sizeof(struct A2_packed) == 1, "");
_Static_assert(_Alignof(struct A2_packed) == 1, "");
_Static_assert(sizeof(struct A2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct A2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A2_size) == 3, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A_2_alignment) == 2, "");
_Static_assert(_Alignof(struct A_2_alignment) == 1, "");
_Static_assert(sizeof(struct A_2_packed) == 1, "");
_Static_assert(_Alignof(struct A_2_packed) == 1, "");
_Static_assert(sizeof(struct A_2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct A_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A_2_size) == 3, "");
_Static_assert(_Alignof(struct A_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_2_alignment) == 2, "");
_Static_assert(_Alignof(struct B_2_alignment) == 1, "");
_Static_assert(sizeof(struct B_2_packed) == 1, "");
_Static_assert(_Alignof(struct B_2_packed) == 1, "");
_Static_assert(sizeof(struct B_2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct B_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_2_size) == 3, "");
_Static_assert(_Alignof(struct B_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C22_alignment) == 2, "");
_Static_assert(_Alignof(struct C22_alignment) == 1, "");
_Static_assert(sizeof(struct C22_packed) == 1, "");
_Static_assert(_Alignof(struct C22_packed) == 1, "");
_Static_assert(sizeof(struct C22_required_alignment) == 2, "");
_Static_assert(_Alignof(struct C22_required_alignment) == 1, "");
_Static_assert(sizeof(struct C22_size) == 3, "");
_Static_assert(_Alignof(struct C22_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D2_alignment) == 16, "");
_Static_assert(_Alignof(struct D2_alignment) == 8, "");
_Static_assert(sizeof(struct D2_packed) == 8, "");
_Static_assert(_Alignof(struct D2_packed) == 1, "");
_Static_assert(sizeof(struct D2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct D2_required_alignment) == 1, "");
_Static_assert(sizeof(struct D2_size) == 10, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct F2_alignment) == 32, "");
_Static_assert(_Alignof(struct F2_alignment) == 16, "");
_Static_assert(sizeof(struct F2_packed) == 16, "");
_Static_assert(_Alignof(struct F2_packed) == 1, "");
_Static_assert(sizeof(struct F2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct F2_required_alignment) == 1, "");
_Static_assert(sizeof(struct F2_size) == 18, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct G2_alignment) == 10, "");
_Static_assert(_Alignof(struct G2_alignment) == 2, "");
_Static_assert(sizeof(struct G2_packed) == 8, "");
_Static_assert(_Alignof(struct G2_packed) == 1, "");
_Static_assert(sizeof(struct G2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct G2_required_alignment) == 1, "");
_Static_assert(sizeof(struct G2_size) == 10, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct H2_alignment) == 10, "");
_Static_assert(_Alignof(struct H2_alignment) == 2, "");
_Static_assert(sizeof(struct H2_packed) == 8, "");
_Static_assert(_Alignof(struct H2_packed) == 1, "");
_Static_assert(sizeof(struct H2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct H2_required_alignment) == 1, "");
_Static_assert(sizeof(struct H2_size) == 10, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct I2_alignment) == 9, "");
_Static_assert(_Alignof(struct I2_alignment) == 1, "");
_Static_assert(sizeof(struct I2_packed) == 8, "");
_Static_assert(_Alignof(struct I2_packed) == 1, "");
_Static_assert(sizeof(struct I2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct I2_required_alignment) == 1, "");
_Static_assert(sizeof(struct I2_size) == 10, "");
_Static_assert(_Alignof(struct I2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct J2_alignment) == 10, "");
_Static_assert(_Alignof(struct J2_alignment) == 2, "");
_Static_assert(sizeof(struct J2_packed) == 8, "");
_Static_assert(_Alignof(struct J2_packed) == 1, "");
_Static_assert(sizeof(struct J2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct J2_required_alignment) == 1, "");
_Static_assert(sizeof(struct J2_size) == 10, "");
_Static_assert(_Alignof(struct J2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K2_alignment) == 16, "");
_Static_assert(_Alignof(struct K2_alignment) == 8, "");
_Static_assert(sizeof(struct K2_packed) == 8, "");
_Static_assert(_Alignof(struct K2_packed) == 1, "");
_Static_assert(sizeof(struct K2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct K2_required_alignment) == 1, "");
_Static_assert(sizeof(struct K2_size) == 10, "");
_Static_assert(_Alignof(struct K2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct L2_alignment) == 32, "");
_Static_assert(_Alignof(struct L2_alignment) == 16, "");
_Static_assert(sizeof(struct L2_packed) == 16, "");
_Static_assert(_Alignof(struct L2_packed) == 1, "");
_Static_assert(sizeof(struct L2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct L2_required_alignment) == 1, "");
_Static_assert(sizeof(struct L2_size) == 18, "");
_Static_assert(_Alignof(struct L2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct M2_alignment) == 4, "");
_Static_assert(_Alignof(struct M2_alignment) == 2, "");
_Static_assert(sizeof(struct M2_packed) == 2, "");
_Static_assert(_Alignof(struct M2_packed) == 1, "");
_Static_assert(sizeof(struct M2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct M2_required_alignment) == 1, "");
_Static_assert(sizeof(struct M2_size) == 4, "");
_Static_assert(_Alignof(struct M2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct N2_alignment) == 4, "");
_Static_assert(_Alignof(struct N2_alignment) == 2, "");
_Static_assert(sizeof(struct N2_packed) == 2, "");
_Static_assert(_Alignof(struct N2_packed) == 1, "");
_Static_assert(sizeof(struct N2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct N2_required_alignment) == 1, "");
_Static_assert(sizeof(struct N2_size) == 4, "");
_Static_assert(_Alignof(struct N2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct O2_alignment) == 2, "");
_Static_assert(_Alignof(struct O2_alignment) == 1, "");
_Static_assert(sizeof(struct O2_packed) == 1, "");
_Static_assert(_Alignof(struct O2_packed) == 1, "");
_Static_assert(sizeof(struct O2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct O2_required_alignment) == 1, "");
_Static_assert(sizeof(struct O2_size) == 3, "");
_Static_assert(_Alignof(struct O2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct P2_alignment) == 4, "");
_Static_assert(_Alignof(struct P2_alignment) == 2, "");
_Static_assert(sizeof(struct P2_packed) == 2, "");
_Static_assert(_Alignof(struct P2_packed) == 1, "");
_Static_assert(sizeof(struct P2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct P2_required_alignment) == 1, "");
_Static_assert(sizeof(struct P2_size) == 4, "");
_Static_assert(_Alignof(struct P2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q2_alignment) == 16, "");
_Static_assert(_Alignof(struct Q2_alignment) == 8, "");
_Static_assert(sizeof(struct Q2_packed) == 8, "");
_Static_assert(_Alignof(struct Q2_packed) == 1, "");
_Static_assert(sizeof(struct Q2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct Q2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q2_size) == 10, "");
_Static_assert(_Alignof(struct Q2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct R2_alignment) == 2, "");
_Static_assert(_Alignof(struct R2_alignment) == 1, "");
_Static_assert(sizeof(struct R2_packed) == 1, "");
_Static_assert(_Alignof(struct R2_packed) == 1, "");
_Static_assert(sizeof(struct R2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct R2_required_alignment) == 1, "");
_Static_assert(sizeof(struct R2_size) == 3, "");
_Static_assert(_Alignof(struct R2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S2_alignment) == 2, "");
_Static_assert(_Alignof(struct S2_alignment) == 1, "");
_Static_assert(sizeof(struct S2_packed) == 1, "");
_Static_assert(_Alignof(struct S2_packed) == 1, "");
_Static_assert(sizeof(struct S2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct S2_required_alignment) == 1, "");
_Static_assert(sizeof(struct S2_size) == 3, "");
_Static_assert(_Alignof(struct S2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T2_alignment) == 2, "");
_Static_assert(_Alignof(struct T2_alignment) == 1, "");
_Static_assert(sizeof(struct T2_packed) == 1, "");
_Static_assert(_Alignof(struct T2_packed) == 1, "");
_Static_assert(sizeof(struct T2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct T2_required_alignment) == 1, "");
_Static_assert(sizeof(struct T2_size) == 3, "");
_Static_assert(_Alignof(struct T2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U2_alignment) == 2, "");
_Static_assert(_Alignof(struct U2_alignment) == 1, "");
_Static_assert(sizeof(struct U2_packed) == 1, "");
_Static_assert(_Alignof(struct U2_packed) == 1, "");
_Static_assert(sizeof(struct U2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct U2_required_alignment) == 1, "");
_Static_assert(sizeof(struct U2_size) == 3, "");
_Static_assert(_Alignof(struct U2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V2_alignment) == 2, "");
_Static_assert(_Alignof(struct V2_alignment) == 1, "");
_Static_assert(sizeof(struct V2_packed) == 1, "");
_Static_assert(_Alignof(struct V2_packed) == 1, "");
_Static_assert(sizeof(struct V2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct V2_required_alignment) == 1, "");
_Static_assert(sizeof(struct V2_size) == 3, "");
_Static_assert(_Alignof(struct V2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W2_alignment) == 2, "");
_Static_assert(_Alignof(struct W2_alignment) == 1, "");
_Static_assert(sizeof(struct W2_packed) == 1, "");
_Static_assert(_Alignof(struct W2_packed) == 1, "");
_Static_assert(sizeof(struct W2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct W2_required_alignment) == 1, "");
_Static_assert(sizeof(struct W2_size) == 3, "");
_Static_assert(_Alignof(struct W2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W_2_alignment) == 2, "");
_Static_assert(_Alignof(struct W_2_alignment) == 1, "");
_Static_assert(sizeof(struct W_2_packed) == 1, "");
_Static_assert(_Alignof(struct W_2_packed) == 1, "");
_Static_assert(sizeof(struct W_2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct W_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct W_2_size) == 3, "");
_Static_assert(_Alignof(struct W_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X2_alignment) == 2, "");
_Static_assert(_Alignof(struct X2_alignment) == 1, "");
_Static_assert(sizeof(struct X2_packed) == 1, "");
_Static_assert(_Alignof(struct X2_packed) == 1, "");
_Static_assert(sizeof(struct X2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct X2_required_alignment) == 1, "");
_Static_assert(sizeof(struct X2_size) == 3, "");
_Static_assert(_Alignof(struct X2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 10, "");
_Static_assert(_Alignof(struct Y_alignment) == 1, "");
_Static_assert(sizeof(struct Y_packed) == 9, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 10, "");
_Static_assert(_Alignof(struct Y_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y_size) == 11, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y2_alignment) == 2, "");
_Static_assert(_Alignof(struct Y2_alignment) == 1, "");
_Static_assert(sizeof(struct Y2_packed) == 1, "");
_Static_assert(_Alignof(struct Y2_packed) == 1, "");
_Static_assert(sizeof(struct Y2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct Y2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y2_size) == 3, "");
_Static_assert(_Alignof(struct Y2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A3_alignment) == 34, "");
_Static_assert(_Alignof(struct A3_alignment) == 1, "");
_Static_assert(sizeof(struct A3_packed) == 33, "");
_Static_assert(_Alignof(struct A3_packed) == 1, "");
_Static_assert(sizeof(struct A3_required_alignment) == 34, "");
_Static_assert(_Alignof(struct A3_required_alignment) == 1, "");
_Static_assert(sizeof(struct A3_size) == 35, "");
_Static_assert(_Alignof(struct A3_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A4_alignment) == 64, "");
_Static_assert(_Alignof(struct A4_alignment) == 32, "");
_Static_assert(sizeof(struct A4_packed) == 1, "");
_Static_assert(_Alignof(struct A4_packed) == 1, "");
_Static_assert(sizeof(struct A4_required_alignment) == 2, "");
_Static_assert(_Alignof(struct A4_required_alignment) == 1, "");
_Static_assert(sizeof(struct A4_size) == 3, "");
_Static_assert(_Alignof(struct A4_size) == 1, "");
#endif
_Static_assert(sizeof(A5) == 33, "");
_Static_assert(_Alignof(A5) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A5_alignment) == 34, "");
_Static_assert(_Alignof(struct A5_alignment) == 1, "");
_Static_assert(sizeof(struct A5_packed) == 33, "");
_Static_assert(_Alignof(struct A5_packed) == 1, "");
_Static_assert(sizeof(struct A5_required_alignment) == 34, "");
_Static_assert(_Alignof(struct A5_required_alignment) == 1, "");
_Static_assert(sizeof(struct A5_size) == 35, "");
_Static_assert(_Alignof(struct A5_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A7_alignment) == 64, "");
_Static_assert(_Alignof(struct A7_alignment) == 32, "");
_Static_assert(sizeof(struct A7_packed) == 32, "");
_Static_assert(_Alignof(struct A7_packed) == 1, "");
_Static_assert(sizeof(struct A7_required_alignment) == 33, "");
_Static_assert(_Alignof(struct A7_required_alignment) == 1, "");
_Static_assert(sizeof(struct A7_size) == 34, "");
_Static_assert(_Alignof(struct A7_size) == 1, "");
#endif
_Static_assert(sizeof(A8) == 8, "");
_Static_assert(_Alignof(A8) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A8_alignment) == 16, "");
_Static_assert(_Alignof(struct A8_alignment) == 8, "");
_Static_assert(sizeof(struct A8_packed) == 8, "");
_Static_assert(_Alignof(struct A8_packed) == 1, "");
_Static_assert(sizeof(struct A8_required_alignment) == 9, "");
_Static_assert(_Alignof(struct A8_required_alignment) == 1, "");
_Static_assert(sizeof(struct A8_size) == 10, "");
_Static_assert(_Alignof(struct A8_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A9_alignment) == 24, "");
_Static_assert(_Alignof(struct A9_alignment) == 8, "");
_Static_assert(sizeof(struct A9_packed) == 16, "");
_Static_assert(_Alignof(struct A9_packed) == 1, "");
_Static_assert(sizeof(struct A9_required_alignment) == 17, "");
_Static_assert(_Alignof(struct A9_required_alignment) == 1, "");
_Static_assert(sizeof(struct A9_size) == 18, "");
_Static_assert(_Alignof(struct A9_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A10_alignment) == 32, "");
_Static_assert(_Alignof(struct A10_alignment) == 16, "");
_Static_assert(sizeof(struct A10_packed) == 8, "");
_Static_assert(_Alignof(struct A10_packed) == 1, "");
_Static_assert(sizeof(struct A10_required_alignment) == 9, "");
_Static_assert(_Alignof(struct A10_required_alignment) == 1, "");
_Static_assert(sizeof(struct A10_size) == 10, "");
_Static_assert(_Alignof(struct A10_size) == 1, "");
#endif
_Static_assert(sizeof(A11) == 16, "");
_Static_assert(_Alignof(A11) == 16, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A11_alignment) == 32, "");
_Static_assert(_Alignof(struct A11_alignment) == 16, "");
_Static_assert(sizeof(struct A11_packed) == 16, "");
_Static_assert(_Alignof(struct A11_packed) == 1, "");
_Static_assert(sizeof(struct A11_required_alignment) == 17, "");
_Static_assert(_Alignof(struct A11_required_alignment) == 1, "");
_Static_assert(sizeof(struct A11_size) == 18, "");
_Static_assert(_Alignof(struct A11_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A12_alignment) == 48, "");
_Static_assert(_Alignof(struct A12_alignment) == 16, "");
_Static_assert(sizeof(struct A12_packed) == 32, "");
_Static_assert(_Alignof(struct A12_packed) == 1, "");
_Static_assert(sizeof(struct A12_required_alignment) == 33, "");
_Static_assert(_Alignof(struct A12_required_alignment) == 1, "");
_Static_assert(sizeof(struct A12_size) == 34, "");
_Static_assert(_Alignof(struct A12_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A13_alignment) == 48, "");
_Static_assert(_Alignof(struct A13_alignment) == 16, "");
_Static_assert(sizeof(struct A13_packed) == 32, "");
_Static_assert(_Alignof(struct A13_packed) == 1, "");
_Static_assert(sizeof(struct A13_required_alignment) == 33, "");
_Static_assert(_Alignof(struct A13_required_alignment) == 1, "");
_Static_assert(sizeof(struct A13_size) == 34, "");
_Static_assert(_Alignof(struct A13_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A__alignment) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B__alignment) == 24, "");
_Static_assert(_Alignof(struct B__alignment) == 8, "");
_Static_assert(sizeof(struct B__packed) == 16, "");
_Static_assert(_Alignof(struct B__packed) == 1, "");
_Static_assert(sizeof(struct B__required_alignment) == 17, "");
_Static_assert(_Alignof(struct B__required_alignment) == 1, "");
_Static_assert(sizeof(struct B__size) == 18, "");
_Static_assert(_Alignof(struct B__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B_,d) == 64, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 24, "");
_Static_assert(_Alignof(struct C__alignment) == 8, "");
_Static_assert(sizeof(struct C__packed) == 16, "");
_Static_assert(_Alignof(struct C__packed) == 1, "");
_Static_assert(sizeof(struct C__required_alignment) == 17, "");
_Static_assert(_Alignof(struct C__required_alignment) == 1, "");
_Static_assert(sizeof(struct C__size) == 18, "");
_Static_assert(_Alignof(struct C__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C_,d) == 64, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct R_alignment) == 48, "");
_Static_assert(_Alignof(struct R_alignment) == 16, "");
_Static_assert(sizeof(struct R_packed) == 32, "");
_Static_assert(_Alignof(struct R_packed) == 1, "");
_Static_assert(sizeof(struct R_required_alignment) == 33, "");
_Static_assert(_Alignof(struct R_required_alignment) == 1, "");
_Static_assert(sizeof(struct R_size) == 34, "");
_Static_assert(_Alignof(struct R_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(R,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 24, "");
_Static_assert(_Alignof(struct S_alignment) == 8, "");
_Static_assert(sizeof(struct S_packed) == 16, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 17, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 18, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T_alignment) == 24, "");
_Static_assert(_Alignof(struct T_alignment) == 8, "");
_Static_assert(sizeof(struct T_packed) == 16, "");
_Static_assert(_Alignof(struct T_packed) == 1, "");
_Static_assert(sizeof(struct T_required_alignment) == 17, "");
_Static_assert(_Alignof(struct T_required_alignment) == 1, "");
_Static_assert(sizeof(struct T_size) == 18, "");
_Static_assert(_Alignof(struct T_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 24, "");
_Static_assert(_Alignof(struct U_alignment) == 8, "");
_Static_assert(sizeof(struct U_packed) == 16, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 17, "");
_Static_assert(_Alignof(struct U_required_alignment) == 1, "");
_Static_assert(sizeof(struct U_size) == 18, "");
_Static_assert(_Alignof(struct U_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 24, "");
_Static_assert(_Alignof(struct V_alignment) == 8, "");
_Static_assert(sizeof(struct V_packed) == 16, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 17, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 18, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W_alignment) == 48, "");
_Static_assert(_Alignof(struct W_alignment) == 16, "");
_Static_assert(sizeof(struct W_packed) == 32, "");
_Static_assert(_Alignof(struct W_packed) == 1, "");
_Static_assert(sizeof(struct W_required_alignment) == 33, "");
_Static_assert(_Alignof(struct W_required_alignment) == 1, "");
_Static_assert(sizeof(struct W_size) == 34, "");
_Static_assert(_Alignof(struct W_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(W,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W__alignment) == 48, "");
_Static_assert(_Alignof(struct W__alignment) == 16, "");
_Static_assert(sizeof(struct W__packed) == 32, "");
_Static_assert(_Alignof(struct W__packed) == 1, "");
_Static_assert(sizeof(struct W__required_alignment) == 33, "");
_Static_assert(_Alignof(struct W__required_alignment) == 1, "");
_Static_assert(sizeof(struct W__size) == 34, "");
_Static_assert(_Alignof(struct W__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(W_,e) == 128, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X_alignment) == 48, "");
_Static_assert(_Alignof(struct X_alignment) == 16, "");
_Static_assert(sizeof(struct X_packed) == 32, "");
_Static_assert(_Alignof(struct X_packed) == 1, "");
_Static_assert(sizeof(struct X_required_alignment) == 33, "");
_Static_assert(_Alignof(struct X_required_alignment) == 1, "");
_Static_assert(sizeof(struct X_size) == 34, "");
_Static_assert(_Alignof(struct X_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(X,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A2_alignment) == 8, "");
_Static_assert(_Alignof(struct A2_alignment) == 4, "");
_Static_assert(sizeof(struct A2_packed) == 4, "");
_Static_assert(_Alignof(struct A2_packed) == 1, "");
_Static_assert(sizeof(struct A2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct A2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A2_size) == 6, "");
_Static_assert(_Alignof(struct A2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A_2_alignment) == 8, "");
_Static_assert(_Alignof(struct A_2_alignment) == 4, "");
_Static_assert(sizeof(struct A_2_packed) == 4, "");
_Static_assert(_Alignof(struct A_2_packed) == 1, "");
_Static_assert(sizeof(struct A_2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct A_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct A_2_size) == 6, "");
_Static_assert(_Alignof(struct A_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A_2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_2_alignment) == 16, "");
_Static_assert(_Alignof(struct B_2_alignment) == 8, "");
_Static_assert(sizeof(struct B_2_packed) == 8, "");
_Static_assert(_Alignof(struct B_2_packed) == 1, "");
_Static_assert(sizeof(struct B_2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct B_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_2_size) == 10, "");
_Static_assert(_Alignof(struct B_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B_2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C22_alignment) == 16, "");
_Static_assert(_Alignof(struct C22_alignment) == 8, "");
_Static_assert(sizeof(struct C22_packed) == 8, "");
_Static_assert(_Alignof(struct C22_packed) == 1, "");
_Static_assert(sizeof(struct C22_required_alignment) == 9, "");
_Static_assert(_Alignof(struct C22_required_alignment) == 1, "");
_Static_assert(sizeof(struct C22_size) == 10, "");
_Static_assert(_Alignof(struct C22_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C22,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct R2_alignment) == 32, "");
_Static_assert(_Alignof(struct R2_alignment) == 16, "");
_Static_assert(sizeof(struct R2_packed) == 16, "");
_Static_assert(_Alignof(struct R2_packed) == 1, "");
_Static_assert(sizeof(struct R2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct R2_required_alignment) == 1, "");
_Static_assert(sizeof(struct R2_size) == 18, "");
_Static_assert(_Alignof(struct R2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(R2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S2_alignment) == 16, "");
_Static_assert(_Alignof(struct S2_alignment) == 8, "");
_Static_assert(sizeof(struct S2_packed) == 8, "");
_Static_assert(_Alignof(struct S2_packed) == 1, "");
_Static_assert(sizeof(struct S2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct S2_required_alignment) == 1, "");
_Static_assert(sizeof(struct S2_size) == 10, "");
_Static_assert(_Alignof(struct S2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T2_alignment) == 16, "");
_Static_assert(_Alignof(struct T2_alignment) == 8, "");
_Static_assert(sizeof(struct T2_packed) == 8, "");
_Static_assert(_Alignof(struct T2_packed) == 1, "");
_Static_assert(sizeof(struct T2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct T2_required_alignment) == 1, "");
_Static_assert(sizeof(struct T2_size) == 10, "");
_Static_assert(_Alignof(struct T2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U2_alignment) == 16, "");
_Static_assert(_Alignof(struct U2_alignment) == 8, "");
_Static_assert(sizeof(struct U2_packed) == 8, "");
_Static_assert(_Alignof(struct U2_packed) == 1, "");
_Static_assert(sizeof(struct U2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct U2_required_alignment) == 1, "");
_Static_assert(sizeof(struct U2_size) == 10, "");
_Static_assert(_Alignof(struct U2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V2_alignment) == 16, "");
_Static_assert(_Alignof(struct V2_alignment) == 8, "");
_Static_assert(sizeof(struct V2_packed) == 8, "");
_Static_assert(_Alignof(struct V2_packed) == 1, "");
_Static_assert(sizeof(struct V2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct V2_required_alignment) == 1, "");
_Static_assert(sizeof(struct V2_size) == 10, "");
_Static_assert(_Alignof(struct V2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W2_alignment) == 32, "");
_Static_assert(_Alignof(struct W2_alignment) == 16, "");
_Static_assert(sizeof(struct W2_packed) == 16, "");
_Static_assert(_Alignof(struct W2_packed) == 1, "");
_Static_assert(sizeof(struct W2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct W2_required_alignment) == 1, "");
_Static_assert(sizeof(struct W2_size) == 18, "");
_Static_assert(_Alignof(struct W2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(W2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W_2_alignment) == 32, "");
_Static_assert(_Alignof(struct W_2_alignment) == 16, "");
_Static_assert(sizeof(struct W_2_packed) == 16, "");
_Static_assert(_Alignof(struct W_2_packed) == 1, "");
_Static_assert(sizeof(struct W_2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct W_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct W_2_size) == 18, "");
_Static_assert(_Alignof(struct W_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(W_2,e) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct X2_alignment) == 32, "");
_Static_assert(_Alignof(struct X2_alignment) == 16, "");
_Static_assert(sizeof(struct X2_packed) == 16, "");
_Static_assert(_Alignof(struct X2_packed) == 1, "");
_Static_assert(sizeof(struct X2_required_alignment) == 17, "");
_Static_assert(_Alignof(struct X2_required_alignment) == 1, "");
_Static_assert(sizeof(struct X2_size) == 18, "");
_Static_assert(_Alignof(struct X2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(X2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y2_alignment) == 16, "");
_Static_assert(_Alignof(struct Y2_alignment) == 8, "");
_Static_assert(sizeof(struct Y2_packed) == 8, "");
_Static_assert(_Alignof(struct Y2_packed) == 1, "");
_Static_assert(sizeof(struct Y2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct Y2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y2_size) == 10, "");
_Static_assert(_Alignof(struct Y2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Y2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A3_alignment) == 96, "");
_Static_assert(_Alignof(struct A3_alignment) == 32, "");
_Static_assert(sizeof(struct A3_packed) == 64, "");
_Static_assert(_Alignof(struct A3_packed) == 1, "");
_Static_assert(sizeof(struct A3_required_alignment) == 65, "");
_Static_assert(_Alignof(struct A3_required_alignment) == 1, "");
_Static_assert(sizeof(struct A3_size) == 66, "");
_Static_assert(_Alignof(struct A3_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A3,d) == 256, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A5_alignment) == 96, "");
_Static_assert(_Alignof(struct A5_alignment) == 32, "");
_Static_assert(sizeof(struct A5_packed) == 64, "");
_Static_assert(_Alignof(struct A5_packed) == 1, "");
_Static_assert(sizeof(struct A5_required_alignment) == 65, "");
_Static_assert(_Alignof(struct A5_required_alignment) == 1, "");
_Static_assert(sizeof(struct A5_size) == 66, "");
_Static_assert(_Alignof(struct A5_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A5,d) == 256, "");
...
_Static_assert(_Alignof(A11) == 16, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A11_alignment) == 48, "");
_Static_assert(_Alignof(struct A11_alignment) == 16, "");
_Static_assert(sizeof(struct A11_packed) == 32, "");
_Static_assert(_Alignof(struct A11_packed) == 1, "");
_Static_assert(sizeof(struct A11_required_alignment) == 33, "");
_Static_assert(_Alignof(struct A11_required_alignment) == 1, "");
_Static_assert(sizeof(struct A11_size) == 34, "");
_Static_assert(_Alignof(struct A11_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A11,i) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A8_alignment) == 12, "");
_Static_assert(_Alignof(struct A8_alignment) == 4, "");
_Static_assert(sizeof(struct A8_packed) == 8, "");
_Static_assert(_Alignof(struct A8_packed) == 1, "");
_Static_assert(sizeof(struct A8_required_alignment) == 9, "");
_Static_assert(_Alignof(struct A8_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A9_alignment) == 16, "");
_Static_assert(_Alignof(struct A9_alignment) == 4, "");
_Static_assert(sizeof(struct A9_packed) == 12, "");
_Static_assert(_Alignof(struct A9_packed) == 1, "");
_Static_assert(sizeof(struct A9_required_alignment) == 13, "");
_Static_assert(_Alignof(struct A9_required_alignment) == 1, "");
_Static_assert(sizeof(struct A9_size) == 14, "");
_Static_assert(_Alignof(struct A9_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A9,i) == 8, "");
...
_Static_assert(sizeof(struct A10_alignment) == 32, "");
_Static_assert(_Alignof(struct A10_alignment) == 16, "");
_Static_assert(sizeof(struct A10_packed) == 4, "");
_Static_assert(_Alignof(struct A10_packed) == 1, "");
_Static_assert(sizeof(struct A10_required_alignment) == 5, "");
_Static_assert(_Alignof(struct A10_required_alignment) == 1, "");
_Static_assert(sizeof(struct A10_size) == 6, "");
_Static_assert(_Alignof(struct A10_size) == 1, "");
#endif
_Static_assert(sizeof(A11) == 32, "");
_Static_assert(_Alignof(A11) == 16, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B__alignment) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D_alignment) == 20, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K_alignment) == 4, "");
_Static_assert(_Alignof(struct K_alignment) == 1, "");
_Static_assert(sizeof(struct K_packed) == 3, "");
_Static_assert(_Alignof(struct K_packed) == 1, "");
_Static_assert(sizeof(struct K_required_alignment) == 4, "");
_Static_assert(_Alignof(struct K_required_alignment) == 1, "");
_Static_assert(sizeof(struct K_size) == 5, "");
_Static_assert(_Alignof(struct K_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(K,d) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct P_alignment) == 4, "");
_Static_assert(_Alignof(struct P_alignment) == 1, "");
_Static_assert(sizeof(struct P_packed) == 3, "");
_Static_assert(_Alignof(struct P_packed) == 1, "");
_Static_assert(sizeof(struct P_required_alignment) == 4, "");
_Static_assert(_Alignof(struct P_required_alignment) == 1, "");
_Static_assert(sizeof(struct P_size) == 5, "");
_Static_assert(_Alignof(struct P_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(P,d) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q_alignment) == 4, "");
_Static_assert(_Alignof(struct Q_alignment) == 1, "");
_Static_assert(sizeof(struct Q_packed) == 3, "");
_Static_assert(_Alignof(struct Q_packed) == 1, "");
_Static_assert(sizeof(struct Q_required_alignment) == 4, "");
_Static_assert(_Alignof(struct Q_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q_size) == 5, "");
_Static_assert(_Alignof(struct Q_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 12, "");
_Static_assert(_Alignof(struct S_alignment) == 4, "");
_Static_assert(sizeof(struct S_packed) == 8, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 9, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 10, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T_alignment) == 12, "");
_Static_assert(_Alignof(struct T_alignment) == 4, "");
_Static_assert(sizeof(struct T_packed) == 8, "");
_Static_assert(_Alignof(struct T_packed) == 1, "");
_Static_assert(sizeof(struct T_required_alignment) == 9, "");
_Static_assert(_Alignof(struct T_required_alignment) == 1, "");
_Static_assert(sizeof(struct T_size) == 10, "");
_Static_assert(_Alignof(struct T_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 12, "");
_Static_assert(_Alignof(struct U_alignment) == 4, "");
_Static_assert(sizeof(struct U_packed) == 8, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 9, "");
_Static_assert(_Alignof(struct U_required_alignment) == 1, "");
_Static_assert(sizeof(struct U_size) == 10, "");
_Static_assert(_Alignof(struct U_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 12, "");
_Static_assert(_Alignof(struct V_alignment) == 4, "");
_Static_assert(sizeof(struct V_packed) == 8, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 9, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 10, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B_2_alignment) == 8, "");
_Static_assert(_Alignof(struct B_2_alignment) == 4, "");
_Static_assert(sizeof(struct B_2_packed) == 4, "");
_Static_assert(_Alignof(struct B_2_packed) == 1, "");
_Static_assert(sizeof(struct B_2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct B_2_required_alignment) == 1, "");
_Static_assert(sizeof(struct B_2_size) == 6, "");
_Static_assert(_Alignof(struct B_2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B_2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C22_alignment) == 8, "");
_Static_assert(_Alignof(struct C22_alignment) == 4, "");
_Static_assert(sizeof(struct C22_packed) == 4, "");
_Static_assert(_Alignof(struct C22_packed) == 1, "");
_Static_assert(sizeof(struct C22_required_alignment) == 5, "");
_Static_assert(_Alignof(struct C22_required_alignment) == 1, "");
_Static_assert(sizeof(struct C22_size) == 6, "");
_Static_assert(_Alignof(struct C22_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C22,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D2_alignment) == 12, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K2_alignment) == 2, "");
_Static_assert(_Alignof(struct K2_alignment) == 1, "");
_Static_assert(sizeof(struct K2_packed) == 1, "");
_Static_assert(_Alignof(struct K2_packed) == 1, "");
_Static_assert(sizeof(struct K2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct K2_required_alignment) == 1, "");
_Static_assert(sizeof(struct K2_size) == 3, "");
_Static_assert(_Alignof(struct K2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(K2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct P2_alignment) == 2, "");
_Static_assert(_Alignof(struct P2_alignment) == 1, "");
_Static_assert(sizeof(struct P2_packed) == 1, "");
_Static_assert(_Alignof(struct P2_packed) == 1, "");
_Static_assert(sizeof(struct P2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct P2_required_alignment) == 1, "");
_Static_assert(sizeof(struct P2_size) == 3, "");
_Static_assert(_Alignof(struct P2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(P2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q2_alignment) == 2, "");
_Static_assert(_Alignof(struct Q2_alignment) == 1, "");
_Static_assert(sizeof(struct Q2_packed) == 1, "");
_Static_assert(_Alignof(struct Q2_packed) == 1, "");
_Static_assert(sizeof(struct Q2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct Q2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q2_size) == 3, "");
_Static_assert(_Alignof(struct Q2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S2_alignment) == 8, "");
_Static_assert(_Alignof(struct S2_alignment) == 4, "");
_Static_assert(sizeof(struct S2_packed) == 4, "");
_Static_assert(_Alignof(struct S2_packed) == 1, "");
_Static_assert(sizeof(struct S2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct S2_required_alignment) == 1, "");
_Static_assert(sizeof(struct S2_size) == 6, "");
_Static_assert(_Alignof(struct S2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T2_alignment) == 8, "");
_Static_assert(_Alignof(struct T2_alignment) == 4, "");
_Static_assert(sizeof(struct T2_packed) == 4, "");
_Static_assert(_Alignof(struct T2_packed) == 1, "");
_Static_assert(sizeof(struct T2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct T2_required_alignment) == 1, "");
_Static_assert(sizeof(struct T2_size) == 6, "");
_Static_assert(_Alignof(struct T2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U2_alignment) == 8, "");
_Static_assert(_Alignof(struct U2_alignment) == 4, "");
_Static_assert(sizeof(struct U2_packed) == 4, "");
_Static_assert(_Alignof(struct U2_packed) == 1, "");
_Static_assert(sizeof(struct U2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct U2_required_alignment) == 1, "");
_Static_assert(sizeof(struct U2_size) == 6, "");
_Static_assert(_Alignof(struct U2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V2_alignment) == 8, "");
_Static_assert(_Alignof(struct V2_alignment) == 4, "");
_Static_assert(sizeof(struct V2_packed) == 4, "");
_Static_assert(_Alignof(struct V2_packed) == 1, "");
_Static_assert(sizeof(struct V2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct V2_required_alignment) == 1, "");
_Static_assert(sizeof(struct V2_size) == 6, "");
_Static_assert(_Alignof(struct V2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y2_alignment) == 8, "");
_Static_assert(_Alignof(struct Y2_alignment) == 4, "");
_Static_assert(sizeof(struct Y2_packed) == 4, "");
_Static_assert(_Alignof(struct Y2_packed) == 1, "");
_Static_assert(sizeof(struct Y2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Y2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Y2_size) == 6, "");
_Static_assert(_Alignof(struct Y2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Y2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A8_alignment) == 7, "");
_Static_assert(_Alignof(struct A8_alignment) == 1, "");
_Static_assert(sizeof(struct A8_packed) == 6, "");
_Static_assert(_Alignof(struct A8_packed) == 1, "");
_Static_assert(sizeof(struct A8_required_alignment) == 7, "");
_Static_assert(_Alignof(struct A8_required_alignment) == 1, "");
_Static_assert(sizeof(struct A8_size) == 8, "");
_Static_assert(_Alignof(struct A8_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A8,i) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A11_alignment) == 7, "");
_Static_assert(_Alignof(struct A11_alignment) == 1, "");
_Static_assert(sizeof(struct A11_packed) == 6, "");
_Static_assert(_Alignof(struct A11_packed) == 1, "");
_Static_assert(sizeof(struct A11_required_alignment) == 7, "");
_Static_assert(_Alignof(struct A11_required_alignment) == 1, "");
_Static_assert(sizeof(struct A11_size) == 8, "");
_Static_assert(_Alignof(struct A11_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A11,i) == 8, "");
...
_Static_assert(_Alignof(C_) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 3, "");
_Static_assert(_Alignof(struct C__alignment) == 1, "");
_Static_assert(sizeof(struct C__packed) == 2, "");
_Static_assert(_Alignof(struct C__packed) == 1, "");
_Static_assert(sizeof(struct C__required_alignment) == 3, "");
_Static_assert(_Alignof(struct C__required_alignment) == 1, "");
_Static_assert(sizeof(struct C__size) == 4, "");
_Static_assert(_Alignof(struct C__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D_alignment) == 11, "");
_Static_assert(_Alignof(struct D_alignment) == 1, "");
_Static_assert(sizeof(struct D_packed) == 10, "");
_Static_assert(_Alignof(struct D_packed) == 1, "");
_Static_assert(sizeof(struct D_required_alignment) == 11, "");
_Static_assert(_Alignof(struct D_required_alignment) == 1, "");
_Static_assert(sizeof(struct D_size) == 12, "");
_Static_assert(_Alignof(struct D_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct J_alignment) == 11, "");
_Static_assert(_Alignof(struct J_alignment) == 1, "");
_Static_assert(sizeof(struct J_packed) == 10, "");
_Static_assert(_Alignof(struct J_packed) == 1, "");
_Static_assert(sizeof(struct J_required_alignment) == 11, "");
_Static_assert(_Alignof(struct J_required_alignment) == 1, "");
_Static_assert(sizeof(struct J_size) == 12, "");
_Static_assert(_Alignof(struct J_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 6, "");
_Static_assert(_Alignof(struct S_alignment) == 2, "");
_Static_assert(sizeof(struct S_packed) == 4, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 5, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 6, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S,x) == 8, "");
...
_Static_assert(_Alignof(U) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 4, "");
_Static_assert(_Alignof(struct U_alignment) == 1, "");
_Static_assert(sizeof(struct U_packed) == 3, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 4, "");
_Static_assert(_Alignof(struct U_required_alignment) == 1, "");
_Static_assert(sizeof(struct U_size) == 5, "");
_Static_assert(_Alignof(struct U_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U,x) == 8, "");
...
_Static_assert(_Alignof(V) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 4, "");
_Static_assert(_Alignof(struct V_alignment) == 1, "");
_Static_assert(sizeof(struct V_packed) == 3, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 4, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 5, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D2_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct J2_alignment) == 9, "");
_Static_assert(_Alignof(struct J2_alignment) == 1, "");
_Static_assert(sizeof(struct J2_packed) == 8, "");
_Static_assert(_Alignof(struct J2_packed) == 1, "");
_Static_assert(sizeof(struct J2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct J2_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S2_alignment) == 4, "");
_Static_assert(_Alignof(struct S2_alignment) == 2, "");
_Static_assert(sizeof(struct S2_packed) == 2, "");
_Static_assert(_Alignof(struct S2_packed) == 1, "");
_Static_assert(sizeof(struct S2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct S2_required_alignment) == 1, "");
_Static_assert(sizeof(struct S2_size) == 4, "");
_Static_assert(_Alignof(struct S2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S2,x) == 0, "");
...
_Static_assert(_Alignof(A5) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A5_alignment) == 3, "");
_Static_assert(_Alignof(struct A5_alignment) == 1, "");
_Static_assert(sizeof(struct A5_packed) == 2, "");
_Static_assert(_Alignof(struct A5_packed) == 1, "");
_Static_assert(sizeof(struct A5_required_alignment) == 3, "");
_Static_assert(_Alignof(struct A5_required_alignment) == 1, "");
_Static_assert(sizeof(struct A5_size) == 4, "");
_Static_assert(_Alignof(struct A5_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A9_alignment) == 10, "");
_Static_assert(_Alignof(struct A9_alignment) == 1, "");
_Static_assert(sizeof(struct A9_packed) == 9, "");
_Static_assert(_Alignof(struct A9_packed) == 1, "");
_Static_assert(sizeof(struct A9_required_alignment) == 10, "");
_Static_assert(_Alignof(struct A9_required_alignment) == 1, "");
_Static_assert(sizeof(struct A9_size) == 11, "");
_Static_assert(_Alignof(struct A9_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A9,i) == 8, "");
...
_Static_assert(_Alignof(B_) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct B__alignment) == 6, "");
_Static_assert(_Alignof(struct B__alignment) == 1, "");
_Static_assert(sizeof(struct B__packed) == 5, "");
_Static_assert(_Alignof(struct B__packed) == 1, "");
_Static_assert(sizeof(struct B__required_alignment) == 6, "");
_Static_assert(_Alignof(struct B__required_alignment) == 1, "");
_Static_assert(sizeof(struct B__size) == 7, "");
_Static_assert(_Alignof(struct B__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(B_,d) == 32, "");
...
_Static_assert(_Alignof(C_) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 6, "");
_Static_assert(_Alignof(struct C__alignment) == 1, "");
_Static_assert(sizeof(struct C__packed) == 5, "");
_Static_assert(_Alignof(struct C__packed) == 1, "");
_Static_assert(sizeof(struct C__required_alignment) == 6, "");
_Static_assert(_Alignof(struct C__required_alignment) == 1, "");
_Static_assert(sizeof(struct C__size) == 7, "");
_Static_assert(_Alignof(struct C__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(C_,d) == 32, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K_alignment) == 8, "");
_Static_assert(_Alignof(struct K_alignment) == 4, "");
_Static_assert(sizeof(struct K_packed) == 4, "");
_Static_assert(_Alignof(struct K_packed) == 1, "");
_Static_assert(sizeof(struct K_required_alignment) == 5, "");
_Static_assert(_Alignof(struct K_required_alignment) == 1, "");
_Static_assert(sizeof(struct K_size) == 6, "");
_Static_assert(_Alignof(struct K_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(K,d) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q_alignment) == 8, "");
_Static_assert(_Alignof(struct Q_alignment) == 4, "");
_Static_assert(sizeof(struct Q_packed) == 4, "");
_Static_assert(_Alignof(struct Q_packed) == 1, "");
_Static_assert(sizeof(struct Q_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Q_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q_size) == 6, "");
_Static_assert(_Alignof(struct Q_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q,x) == 8, "");
...
_Static_assert(sizeof(struct S_alignment) == 6, "");
_Static_assert(_Alignof(struct S_alignment) == 1, "");
_Static_assert(sizeof(struct S_packed) == 5, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 6, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 7, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S,x) == 8, "");
...
_Static_assert(_Alignof(T) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T_alignment) == 6, "");
_Static_assert(_Alignof(struct T_alignment) == 1, "");
_Static_assert(sizeof(struct T_packed) == 5, "");
_Static_assert(_Alignof(struct T_packed) == 1, "");
_Static_assert(sizeof(struct T_required_alignment) == 6, "");
_Static_assert(_Alignof(struct T_required_alignment) == 1, "");
_Static_assert(sizeof(struct T_size) == 7, "");
_Static_assert(_Alignof(struct T_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T,x) == 8, "");
...
_Static_assert(_Alignof(U) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 6, "");
_Static_assert(_Alignof(struct U_alignment) == 1, "");
_Static_assert(sizeof(struct U_packed) == 5, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 6, "");
_Static_assert(_Alignof(struct U_required_alignment) == 1, "");
_Static_assert(sizeof(struct U_size) == 7, "");
_Static_assert(_Alignof(struct U_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(U,x) == 8, "");
...
_Static_assert(_Alignof(V) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 6, "");
_Static_assert(_Alignof(struct V_alignment) == 1, "");
_Static_assert(sizeof(struct V_packed) == 5, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 6, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 7, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K2_alignment) == 8, "");
_Static_assert(_Alignof(struct K2_alignment) == 4, "");
_Static_assert(sizeof(struct K2_packed) == 4, "");
_Static_assert(_Alignof(struct K2_packed) == 1, "");
_Static_assert(sizeof(struct K2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct K2_required_alignment) == 1, "");
_Static_assert(sizeof(struct K2_size) == 6, "");
_Static_assert(_Alignof(struct K2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(K2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q2_alignment) == 8, "");
_Static_assert(_Alignof(struct Q2_alignment) == 4, "");
_Static_assert(sizeof(struct Q2_packed) == 4, "");
_Static_assert(_Alignof(struct Q2_packed) == 1, "");
_Static_assert(sizeof(struct Q2_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Q2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q2_size) == 6, "");
_Static_assert(_Alignof(struct Q2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q2,x) == 0, "");
...
_Static_assert(_Alignof(K) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K_alignment) == 32, "");
_Static_assert(_Alignof(struct K_alignment) == 8, "");
_Static_assert(sizeof(struct K_packed) == 24, "");
_Static_assert(_Alignof(struct K_packed) == 1, "");
_Static_assert(sizeof(struct K_required_alignment) == 25, "");
_Static_assert(_Alignof(struct K_required_alignment) == 1, "");
_Static_assert(sizeof(struct K_size) == 26, "");
_Static_assert(_Alignof(struct K_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct M_alignment) == 12, "");
_Static_assert(_Alignof(struct M_alignment) == 1, "");
_Static_assert(sizeof(struct M_packed) == 11, "");
_Static_assert(_Alignof(struct M_packed) == 1, "");
_Static_assert(sizeof(struct M_required_alignment) == 12, "");
_Static_assert(_Alignof(struct M_required_alignment) == 1, "");
_Static_assert(sizeof(struct M_size) == 13, "");
_Static_assert(_Alignof(struct M_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(M,d) == 16, "");
...
_Static_assert(sizeof(struct N_packed) == 11, "");
_Static_assert(_Alignof(struct N_packed) == 1, "");
_Static_assert(sizeof(struct N_required_alignment) == 12, "");
_Static_assert(_Alignof(struct N_required_alignment) == 1, "");
_Static_assert(sizeof(struct N_size) == 13, "");
_Static_assert(_Alignof(struct N_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(N,d) == 16, "");
...
_Static_assert(_Alignof(O) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct O_alignment) == 11, "");
_Static_assert(_Alignof(struct O_alignment) == 1, "");
_Static_assert(sizeof(struct O_packed) == 10, "");
_Static_assert(_Alignof(struct O_packed) == 1, "");
_Static_assert(sizeof(struct O_required_alignment) == 11, "");
_Static_assert(_Alignof(struct O_required_alignment) == 1, "");
_Static_assert(sizeof(struct O_size) == 12, "");
_Static_assert(_Alignof(struct O_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(O,d) == 8, "");
...
_Static_assert(_Alignof(P) == 2, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct P_alignment) == 14, "");
_Static_assert(_Alignof(struct P_alignment) == 2, "");
_Static_assert(sizeof(struct P_packed) == 12, "");
_Static_assert(_Alignof(struct P_packed) == 1, "");
_Static_assert(sizeof(struct P_required_alignment) == 13, "");
_Static_assert(_Alignof(struct P_required_alignment) == 1, "");
_Static_assert(sizeof(struct P_size) == 14, "");
_Static_assert(_Alignof(struct P_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(Q) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q_alignment) == 32, "");
_Static_assert(_Alignof(struct Q_alignment) == 8, "");
_Static_assert(sizeof(struct Q_packed) == 24, "");
_Static_assert(_Alignof(struct Q_packed) == 1, "");
_Static_assert(sizeof(struct Q_required_alignment) == 25, "");
_Static_assert(_Alignof(struct Q_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q_size) == 26, "");
_Static_assert(_Alignof(struct Q_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q,x) == 8, "");
...
_Static_assert(_Alignof(S) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 16, "");
_Static_assert(_Alignof(struct S_alignment) == 8, "");
_Static_assert(sizeof(struct S_packed) == 8, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct T_alignment) == 6, "");
_Static_assert(_Alignof(struct T_alignment) == 2, "");
_Static_assert(sizeof(struct T_packed) == 4, "");
_Static_assert(_Alignof(struct T_packed) == 1, "");
_Static_assert(sizeof(struct T_required_alignment) == 5, "");
_Static_assert(_Alignof(struct T_required_alignment) == 1, "");
_Static_assert(sizeof(struct T_size) == 6, "");
_Static_assert(_Alignof(struct T_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(T,x) == 8, "");
...
_Static_assert(_Alignof(U) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct U_alignment) == 16, "");
_Static_assert(_Alignof(struct U_alignment) == 8, "");
_Static_assert(sizeof(struct U_packed) == 8, "");
_Static_assert(_Alignof(struct U_packed) == 1, "");
_Static_assert(sizeof(struct U_required_alignment) == 9, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct V_alignment) == 6, "");
_Static_assert(_Alignof(struct V_alignment) == 2, "");
_Static_assert(sizeof(struct V_packed) == 4, "");
_Static_assert(_Alignof(struct V_packed) == 1, "");
_Static_assert(sizeof(struct V_required_alignment) == 5, "");
_Static_assert(_Alignof(struct V_required_alignment) == 1, "");
_Static_assert(sizeof(struct V_size) == 6, "");
_Static_assert(_Alignof(struct V_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(V,x) == 8, "");
...
_Static_assert(_Alignof(W_) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct W__alignment) == 3, "");
_Static_assert(_Alignof(struct W__alignment) == 1, "");
_Static_assert(sizeof(struct W__packed) == 2, "");
_Static_assert(_Alignof(struct W__packed) == 1, "");
_Static_assert(sizeof(struct W__required_alignment) == 3, "");
_Static_assert(_Alignof(struct W__required_alignment) == 1, "");
_Static_assert(sizeof(struct W__size) == 4, "");
_Static_assert(_Alignof(struct W__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct M2_alignment) == 2, "");
_Static_assert(_Alignof(struct M2_alignment) == 1, "");
_Static_assert(sizeof(struct M2_packed) == 1, "");
_Static_assert(_Alignof(struct M2_packed) == 1, "");
_Static_assert(sizeof(struct M2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct M2_required_alignment) == 1, "");
_Static_assert(sizeof(struct M2_size) == 3, "");
_Static_assert(_Alignof(struct M2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(M2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct N2_alignment) == 2, "");
_Static_assert(_Alignof(struct N2_alignment) == 1, "");
_Static_assert(sizeof(struct N2_packed) == 1, "");
_Static_assert(_Alignof(struct N2_packed) == 1, "");
_Static_assert(sizeof(struct N2_required_alignment) == 2, "");
_Static_assert(_Alignof(struct N2_required_alignment) == 1, "");
_Static_assert(sizeof(struct N2_size) == 3, "");
_Static_assert(_Alignof(struct N2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(N2,d) == 0, "");
...
_Static_assert(_Alignof(Y) == 8, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Y_alignment) == 16, "");
_Static_assert(_Alignof(struct Y_alignment) == 8, "");
_Static_assert(sizeof(struct Y_packed) == 8, "");
_Static_assert(_Alignof(struct Y_packed) == 1, "");
_Static_assert(sizeof(struct Y_required_alignment) == 9, "");
...
_Static_assert(_Alignof(A5) == 32, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A5_alignment) == 64, "");
_Static_assert(_Alignof(struct A5_alignment) == 32, "");
_Static_assert(sizeof(struct A5_packed) == 32, "");
_Static_assert(_Alignof(struct A5_packed) == 1, "");
_Static_assert(sizeof(struct A5_required_alignment) == 33, "");
_Static_assert(_Alignof(struct A5_required_alignment) == 1, "");
_Static_assert(sizeof(struct A5_size) == 34, "");
_Static_assert(_Alignof(struct A5_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A5,d) == 8, "");
...
_Static_assert(sizeof(struct A8_alignment) == 16, "");
_Static_assert(_Alignof(struct A8_alignment) == 4, "");
_Static_assert(sizeof(struct A8_packed) == 12, "");
_Static_assert(_Alignof(struct A8_packed) == 1, "");
_Static_assert(sizeof(struct A8_required_alignment) == 13, "");
_Static_assert(_Alignof(struct A8_required_alignment) == 1, "");
_Static_assert(sizeof(struct A8_size) == 14, "");
_Static_assert(_Alignof(struct A8_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A8,i) == 8, "");
...
_Static_assert(_Alignof(A13) == 16, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A13_alignment) == 32, "");
_Static_assert(_Alignof(struct A13_alignment) == 16, "");
_Static_assert(sizeof(struct A13_packed) == 16, "");
_Static_assert(_Alignof(struct A13_packed) == 1, "");
_Static_assert(sizeof(struct A13_required_alignment) == 17, "");
_Static_assert(_Alignof(struct A13_required_alignment) == 1, "");
_Static_assert(sizeof(struct A13_size) == 18, "");
_Static_assert(_Alignof(struct A13_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
_Static_assert(_Alignof(C_) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct C__alignment) == 4, "");
_Static_assert(_Alignof(struct C__alignment) == 1, "");
_Static_assert(sizeof(struct C__packed) == 3, "");
_Static_assert(_Alignof(struct C__packed) == 1, "");
_Static_assert(sizeof(struct C__required_alignment) == 4, "");
_Static_assert(_Alignof(struct C__required_alignment) == 1, "");
_Static_assert(sizeof(struct C__size) == 5, "");
_Static_assert(_Alignof(struct C__size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D_alignment) == 14, "");
_Static_assert(_Alignof(struct D_alignment) == 2, "");
_Static_assert(sizeof(struct D_packed) == 12, "");
_Static_assert(_Alignof(struct D_packed) == 1, "");
_Static_assert(sizeof(struct D_required_alignment) == 13, "");
_Static_assert(_Alignof(struct D_required_alignment) == 1, "");
_Static_assert(sizeof(struct D_size) == 14, "");
_Static_assert(_Alignof(struct D_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K_alignment) == 6, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q_alignment) == 6, "");
_Static_assert(_Alignof(struct Q_alignment) == 2, "");
_Static_assert(sizeof(struct Q_packed) == 4, "");
_Static_assert(_Alignof(struct Q_packed) == 1, "");
_Static_assert(sizeof(struct Q_required_alignment) == 5, "");
_Static_assert(_Alignof(struct Q_required_alignment) == 1, "");
...
_Static_assert(_Alignof(S) == 1, "");
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct S_alignment) == 4, "");
_Static_assert(_Alignof(struct S_alignment) == 1, "");
_Static_assert(sizeof(struct S_packed) == 3, "");
_Static_assert(_Alignof(struct S_packed) == 1, "");
_Static_assert(sizeof(struct S_required_alignment) == 4, "");
_Static_assert(_Alignof(struct S_required_alignment) == 1, "");
_Static_assert(sizeof(struct S_size) == 5, "");
_Static_assert(_Alignof(struct S_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(S,x) == 8, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct D2_alignment) == 10, "");
_Static_assert(_Alignof(struct D2_alignment) == 2, "");
_Static_assert(sizeof(struct D2_packed) == 8, "");
_Static_assert(_Alignof(struct D2_packed) == 1, "");
_Static_assert(sizeof(struct D2_required_alignment) == 9, "");
_Static_assert(_Alignof(struct D2_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct K2_alignment) == 4, "");
_Static_assert(_Alignof(struct K2_alignment) == 2, "");
_Static_assert(sizeof(struct K2_packed) == 2, "");
_Static_assert(_Alignof(struct K2_packed) == 1, "");
_Static_assert(sizeof(struct K2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct K2_required_alignment) == 1, "");
_Static_assert(sizeof(struct K2_size) == 4, "");
_Static_assert(_Alignof(struct K2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(K2,d) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct Q2_alignment) == 4, "");
_Static_assert(_Alignof(struct Q2_alignment) == 2, "");
_Static_assert(sizeof(struct Q2_packed) == 2, "");
_Static_assert(_Alignof(struct Q2_packed) == 1, "");
_Static_assert(sizeof(struct Q2_required_alignment) == 3, "");
_Static_assert(_Alignof(struct Q2_required_alignment) == 1, "");
_Static_assert(sizeof(struct Q2_size) == 4, "");
_Static_assert(_Alignof(struct Q2_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(Q2,x) == 0, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A8_alignment) == 8, "");
_Static_assert(_Alignof(struct A8_alignment) == 2, "");
_Static_assert(sizeof(struct A8_packed) == 6, "");
_Static_assert(_Alignof(struct A8_packed) == 1, "");
_Static_assert(sizeof(struct A8_required_alignment) == 7, "");
_Static_assert(_Alignof(struct A8_required_alignment) == 1, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A9_alignment) == 12, "");
_Static_assert(_Alignof(struct A9_alignment) == 2, "");
_Static_assert(sizeof(struct A9_packed) == 10, "");
_Static_assert(_Alignof(struct A9_packed) == 1, "");
_Static_assert(sizeof(struct A9_required_alignment) == 11, "");
_Static_assert(_Alignof(struct A9_required_alignment) == 1, "");
_Static_assert(sizeof(struct A9_size) == 12, "");
_Static_assert(_Alignof(struct A9_size) == 1, "");
#endif
#ifdef CHECK_OFFSETS
_Static_assert(__builtin_bitoffsetof(A9,i) == 8, "");
