...
_Static_assert(sizeof(struct A_packed) == 0, "");
_Static_assert(_Alignof(struct A_packed) == 1, "");
_Static_assert(sizeof(struct A_required_alignment) == 1, "");
_Static_assert(_Alignof(struct A_required_alignment) == 1, "");
_Static_assert(sizeof(struct A_size) == 2, "");
...
#ifdef EXTRA_TESTS
_Static_assert(sizeof(struct A_alignment) == 1, "");
