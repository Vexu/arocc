 ...
 body:
  compound_stmt
    ...
    assign_expr: '*void'
     ...
     rhs:
      implicit cast: (bitcast) '*void'
        block_literal: 'block () [4]int'
         body:
          compound_stmt
            implicit return_stmt: '[4]int'
        ...
        block_literal: 'block () *void'
         body:
          compound_stmt
            return_stmt: '*void'
             expr:
              implicit cast: (int_to_pointer) '*void' (value: 4)
                int_literal: 'int' (value: 4)
    ...
    assign_expr: '*void'
     ...
     rhs:
      implicit cast: (bitcast) '*void'
        block_literal: 'block (a: int) *void'
         body:
          compound_stmt
            return_stmt: '*void'
             expr:
              implicit cast: (int_to_pointer) '*void'
                implicit cast: (lval_to_rval) 'int'
                  decl_ref_expr: 'int' lvalue
                   name: a
    ...
    assign_expr: '*void'
     ...
     rhs:
      implicit cast: (bitcast) '*void'
        block_literal: 'block (a: int) block (x: int) void'
         body:
          compound_stmt
            variable: 'int'
             name: c
            ...
            implicit return_stmt: 'block (x: int) void'
    ...
    assign_expr: '*void'
     ...
     rhs:
      implicit cast: (bitcast) '*void'
        block_literal: 'block (a: int) block (x: int) fn (z: int) void'
         body:
          compound_stmt
            implicit return_stmt: 'block (x: int) fn (z: int) void'
 ...
 body:
  compound_stmt
    ...
    assign_expr: '*void'
     ...
     rhs:
      implicit cast: (bitcast) '*void'
        block_literal: 'block (__NSConstantString_tag: struct __NSConstantString_tag) void'
         body:
          compound_stmt
 ...
 body:
  compound_stmt
    variable: '*void'
     name: b
     init:
      implicit cast: (null_to_pointer) '*void'
        int_literal: 'int' (value: 0)
