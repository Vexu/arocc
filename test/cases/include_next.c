...
#define EXPECTED_ERRORS \
	...
	"include_next.c:7:2: warning: #include_next is a language extension [-Wgnu-include-next]" \
	"include_next.c:7:2: warning: #include_next in primary source file; will search from start of include path [-Winclude-next-outside-header]" \
	"include_next.c:17:5: warning: #include_next in primary source file; will search from start of include path [-Winclude-next-outside-header]" \
