...
#define EXPECTED_ERRORS \
    ...
    "typeof.c:61:13: error: cannot assign to variable 'arr2' with const-qualified type 'const typeof(int [2])'" \
    ...
    "typeof.c:66:13: error: cannot assign to variable 'arr4' with const-qualified type 'typeof(const int [2])'" \
    "typeof.c:65:26: note: variable 'arr4' declared const here" \
    "typeof.c:69:13: error: cannot assign to variable 'arr5' with const-qualified type 'const typeof(int) [2]'" \
    ...
    "typeof.c:77:13: error: cannot assign to variable 'arr8' with const-qualified type 'typeof(const typeof(typeof(int [2])))'" \
    "typeof.c:76:42: note: variable 'arr8' declared const here" \
    "typeof.c:98:29: warning: initializing 'const typeof(int *)' from incompatible type 'const int [2]' discards qualifiers [-Wincompatible-pointer-types-discards-qualifiers]" \
