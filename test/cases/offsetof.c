...
_Static_assert(__builtin_offsetof(struct Anon, s2) > __builtin_offsetof(struct Anon, s3), "");
_Static_assert(__builtin_offsetof(struct Anon, s4) > __builtin_offsetof(struct Anon, s1), "");
